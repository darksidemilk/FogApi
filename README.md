...
### Test the current dev branch version of the module

This wil NOT install the dev version of the module in a persistent fashion, but it will let you test it adhoc in a single powershell session.
