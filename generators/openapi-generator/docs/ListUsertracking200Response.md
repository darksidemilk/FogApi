...
**VarData** | [**Usertracking[]**](Usertracking.md) |  | [optional] 
...
```powershell
$ListUsertracking200Response = Initialize-FogApiListUsertracking200Response  -Draw null `
 -RecordsTotal null `
...
```powershell
$ListUsertracking200Response | ConvertTo-JSON
```
