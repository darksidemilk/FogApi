...
**VarData** | [**Tasklog[]**](Tasklog.md) |  | [optional] 
...
```powershell
$ListTasklog200Response = Initialize-FogApiListTasklog200Response  -Draw null `
 -RecordsTotal null `
...
```powershell
$ListTasklog200Response | ConvertTo-JSON
```
