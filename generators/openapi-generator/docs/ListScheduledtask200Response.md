...
**VarData** | [**Scheduledtask[]**](Scheduledtask.md) |  | [optional] 
...
```powershell
$ListScheduledtask200Response = Initialize-FogApiListScheduledtask200Response  -Draw null `
 -RecordsTotal null `
...
```powershell
$ListScheduledtask200Response | ConvertTo-JSON
```
