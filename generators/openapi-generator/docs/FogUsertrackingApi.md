# FogApi.FogApi\Api.FogUsertrackingApi

All URIs are relative to *http://fog-dev/fog*

Method | HTTP request | Description
------------- | ------------- | -------------
[**Invoke-FogCountUsertracking**](FogUsertrackingApi.md#Invoke-FogCountUsertracking) | **GET** /usertracking/count | Count usertracking
[**Invoke-FogIdsUsertracking**](FogUsertrackingApi.md#Invoke-FogIdsUsertracking) | **GET** /usertracking/ids | Ids for usertracking
[**ConvertTo-FogdivUsertracking**](FogUsertrackingApi.md#ConvertTo-FogdivUsertracking) | **GET** /usertracking/{id} | Get one usertracking by id
[**Invoke-FogListUsertracking**](FogUsertrackingApi.md#Invoke-FogListUsertracking) | **GET** /usertracking | List usertracking
[**Move-FogsUsertracking**](FogUsertrackingApi.md#Move-FogsUsertracking) | **GET** /usertracking/names | Id and name pairs for usertracking


<a id="Invoke-FogCountUsertracking"></a>
# **Invoke-FogCountUsertracking**
> CountFiledeletequeue200Response Invoke-FogCountUsertracking<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Filter] <String><br>
...
# Count usertracking
try {
    $Result = Invoke-FogCountUsertracking -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogCountUsertracking: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
...
<a id="Invoke-FogIdsUsertracking"></a>
# **Invoke-FogIdsUsertracking**
> SystemCollectionsHashtable[] Invoke-FogIdsUsertracking<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Filter] <String><br>

Ids for usertracking
...
# Ids for usertracking
try {
    $Result = Invoke-FogIdsUsertracking -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogIdsUsertracking: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="ConvertTo-FogdivUsertracking"></a>
# **ConvertTo-FogdivUsertracking**
> Usertracking ConvertTo-FogdivUsertracking<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <Int32><br>
...
# Get one usertracking by id
try {
    $Result = ConvertTo-FogdivUsertracking -Id $Id
} catch {
    Write-Host ("Exception occurred when calling ConvertTo-FogdivUsertracking: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
[**Usertracking**](Usertracking.md) (PSCustomObject)
...
<a id="Invoke-FogListUsertracking"></a>
# **Invoke-FogListUsertracking**
> ListUsertracking200Response Invoke-FogListUsertracking<br>
...
# List usertracking
try {
    $Result = Invoke-FogListUsertracking -Start $Start -Length $Length -Expand $Expand -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogListUsertracking: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
[**ListUsertracking200Response**](ListUsertracking200Response.md) (PSCustomObject)
...
<a id="Move-FogsUsertracking"></a>
# **Move-FogsUsertracking**
> SystemCollectionsHashtable[] Move-FogsUsertracking<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Filter] <String><br>

Id and name pairs for usertracking
...
# Id and name pairs for usertracking
try {
    $Result = Move-FogsUsertracking -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Move-FogsUsertracking: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
