...
**VarData** | [**Imagetype[]**](Imagetype.md) |  | [optional] 
...
```powershell
$ListImagetype200Response = Initialize-FogApiListImagetype200Response  -Draw null `
 -RecordsTotal null `
...
```powershell
$ListImagetype200Response | ConvertTo-JSON
```
