# ListHostscreensetting200Response
## Properties
...
**VarData** | [**Hostscreensetting[]**](Hostscreensetting.md) |  | [optional] 
...
```powershell
$ListHostscreensetting200Response = Initialize-FogApiListHostscreensetting200Response  -Draw null `
 -RecordsTotal null `
...
```powershell
$ListHostscreensetting200Response | ConvertTo-JSON
```
