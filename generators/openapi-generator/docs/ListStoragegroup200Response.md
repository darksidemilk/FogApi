...
**VarData** | [**Storagegroup[]**](Storagegroup.md) |  | [optional] 
...
```powershell
$ListStoragegroup200Response = Initialize-FogApiListStoragegroup200Response  -Draw null `
 -RecordsTotal null `
...
```powershell
$ListStoragegroup200Response | ConvertTo-JSON
```
