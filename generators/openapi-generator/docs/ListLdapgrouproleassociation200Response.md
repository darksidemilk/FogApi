...
**VarData** | [**Ldapgrouproleassociation[]**](Ldapgrouproleassociation.md) |  | [optional] 
...
```powershell
$ListLdapgrouproleassociation200Response = Initialize-FogApiListLdapgrouproleassociation200Response  -Draw null `
 -RecordsTotal null `
...
```powershell
$ListLdapgrouproleassociation200Response | ConvertTo-JSON
```
