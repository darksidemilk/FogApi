# ListModuleassociation200Response
## Properties
...
**VarData** | [**Moduleassociation[]**](Moduleassociation.md) |  | [optional] 
...
```powershell
$ListModuleassociation200Response = Initialize-FogApiListModuleassociation200Response  -Draw null `
 -RecordsTotal null `
...
```powershell
$ListModuleassociation200Response | ConvertTo-JSON
```
