...
**VarData** | [**Storagenode[]**](Storagenode.md) |  | [optional] 
...
```powershell
$ListStoragenode200Response = Initialize-FogApiListStoragenode200Response  -Draw null `
 -RecordsTotal null `
...
```powershell
$ListStoragenode200Response | ConvertTo-JSON
```
