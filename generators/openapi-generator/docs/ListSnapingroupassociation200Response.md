# ListSnapingroupassociation200Response
## Properties
...
**VarData** | [**Snapingroupassociation[]**](Snapingroupassociation.md) |  | [optional] 
...
```powershell
$ListSnapingroupassociation200Response = Initialize-FogApiListSnapingroupassociation200Response  -Draw null `
 -RecordsTotal null `
...
```powershell
$ListSnapingroupassociation200Response | ConvertTo-JSON
```
