...
**VarData** | [**Inventory[]**](Inventory.md) |  | [optional] 
...
```powershell
$ListInventory200Response = Initialize-FogApiListInventory200Response  -Draw null `
 -RecordsTotal null `
...
```powershell
$ListInventory200Response | ConvertTo-JSON
```
