...
**VarData** | [**Tasktype[]**](Tasktype.md) |  | [optional] 
...
```powershell
$ListTasktype200Response = Initialize-FogApiListTasktype200Response  -Draw null `
 -RecordsTotal null `
...
```powershell
$ListTasktype200Response | ConvertTo-JSON
```
