...
**VarData** | [**Taskstate[]**](Taskstate.md) |  | [optional] 
...
```powershell
$ListTaskstate200Response = Initialize-FogApiListTaskstate200Response  -Draw null `
 -RecordsTotal null `
...
```powershell
$ListTaskstate200Response | ConvertTo-JSON
```
