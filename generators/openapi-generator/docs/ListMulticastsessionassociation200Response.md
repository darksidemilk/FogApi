# ListMulticastsessionassociation200Response
## Properties
...
**VarData** | [**Multicastsessionassociation[]**](Multicastsessionassociation.md) |  | [optional] 
...
```powershell
$ListMulticastsessionassociation200Response = Initialize-FogApiListMulticastsessionassociation200Response  -Draw null `
 -RecordsTotal null `
...
```powershell
$ListMulticastsessionassociation200Response | ConvertTo-JSON
```
