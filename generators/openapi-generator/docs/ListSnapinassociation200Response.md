...
**VarData** | [**Snapinassociation[]**](Snapinassociation.md) |  | [optional] 
...
```powershell
$ListSnapinassociation200Response = Initialize-FogApiListSnapinassociation200Response  -Draw null `
 -RecordsTotal null `
...
```powershell
$ListSnapinassociation200Response | ConvertTo-JSON
```
