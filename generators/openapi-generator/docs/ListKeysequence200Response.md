...
**VarData** | [**Keysequence[]**](Keysequence.md) |  | [optional] 
...
```powershell
$ListKeysequence200Response = Initialize-FogApiListKeysequence200Response  -Draw null `
 -RecordsTotal null `
...
```powershell
$ListKeysequence200Response | ConvertTo-JSON
```
