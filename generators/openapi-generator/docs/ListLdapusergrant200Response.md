...
**VarData** | [**Ldapusergrant[]**](Ldapusergrant.md) |  | [optional] 
...
```powershell
$ListLdapusergrant200Response = Initialize-FogApiListLdapusergrant200Response  -Draw null `
 -RecordsTotal null `
...
```powershell
$ListLdapusergrant200Response | ConvertTo-JSON
```
