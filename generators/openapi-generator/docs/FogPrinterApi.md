...
------------- | ------------- | -------------
[**Invoke-FogCountPrinter**](FogPrinterApi.md#Invoke-FogCountPrinter) | **GET** /printer/count | Count printer
[**New-FogPrinter**](FogPrinterApi.md#New-FogPrinter) | **POST** /printer | Create a printer
[**Invoke-FogDeletePrinter**](FogPrinterApi.md#Invoke-FogDeletePrinter) | **DELETE** /printer/{id} | Delete a printer
[**Invoke-FogIdsPrinter**](FogPrinterApi.md#Invoke-FogIdsPrinter) | **GET** /printer/ids | Ids for printer
[**ConvertTo-FogdivPrinter**](FogPrinterApi.md#ConvertTo-FogdivPrinter) | **GET** /printer/{id} | Get one printer by id
[**Join-FogPrinter**](FogPrinterApi.md#Join-FogPrinter) | **PUT** /printer/join | Bulk edit printer
[**Invoke-FogListPrinter**](FogPrinterApi.md#Invoke-FogListPrinter) | **GET** /printer | List printer
[**Move-FogsPrinter**](FogPrinterApi.md#Move-FogsPrinter) | **GET** /printer/names | Id and name pairs for printer
[**Search-FogPrinter**](FogPrinterApi.md#Search-FogPrinter) | **GET** /printer/search/{item} | Search printer
[**Update-FogPrinter**](FogPrinterApi.md#Update-FogPrinter) | **PUT** /printer/{id} | Update a printer


<a id="Invoke-FogCountPrinter"></a>
# **Invoke-FogCountPrinter**
> CountFiledeletequeue200Response Invoke-FogCountPrinter<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Filter] <String><br>
...
# Count printer
try {
    $Result = Invoke-FogCountPrinter -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogCountPrinter: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
...
<a id="New-FogPrinter"></a>
# **New-FogPrinter**
> Printer New-FogPrinter<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Printer] <PSCustomObject><br>
...
# Create a printer
try {
    $Result = New-FogPrinter -Printer $Printer
} catch {
    Write-Host ("Exception occurred when calling New-FogPrinter: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
[**Printer**](Printer.md) (PSCustomObject)
...
<a id="Invoke-FogDeletePrinter"></a>
# **Invoke-FogDeletePrinter**
> DeleteFiledeletequeue200Response Invoke-FogDeletePrinter<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <Int32><br>
...
# Delete a printer
try {
    $Result = Invoke-FogDeletePrinter -Id $Id
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogDeletePrinter: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Invoke-FogIdsPrinter"></a>
# **Invoke-FogIdsPrinter**
> SystemCollectionsHashtable[] Invoke-FogIdsPrinter<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Filter] <String><br>
...
# Ids for printer
try {
    $Result = Invoke-FogIdsPrinter -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogIdsPrinter: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="ConvertTo-FogdivPrinter"></a>
# **ConvertTo-FogdivPrinter**
> Printer ConvertTo-FogdivPrinter<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <Int32><br>
...
# Get one printer by id
try {
    $Result = ConvertTo-FogdivPrinter -Id $Id
} catch {
    Write-Host ("Exception occurred when calling ConvertTo-FogdivPrinter: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Join-FogPrinter"></a>
# **Join-FogPrinter**
> void Join-FogPrinter<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-JoinPrinterRequest] <PSCustomObject><br>
...
# Bulk edit printer
try {
    $Result = Join-FogPrinter -JoinPrinterRequest $JoinPrinterRequest
} catch {
    Write-Host ("Exception occurred when calling Join-FogPrinter: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **JoinPrinterRequest** | [**JoinPrinterRequest**](JoinPrinterRequest.md)|  | 
...
<a id="Invoke-FogListPrinter"></a>
# **Invoke-FogListPrinter**
> ListPrinter200Response Invoke-FogListPrinter<br>
...
# List printer
try {
    $Result = Invoke-FogListPrinter -Start $Start -Length $Length -Expand $Expand -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogListPrinter: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
[**ListPrinter200Response**](ListPrinter200Response.md) (PSCustomObject)
...
<a id="Move-FogsPrinter"></a>
# **Move-FogsPrinter**
> SystemCollectionsHashtable[] Move-FogsPrinter<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Filter] <String><br>

Id and name pairs for printer
...
# Id and name pairs for printer
try {
    $Result = Move-FogsPrinter -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Move-FogsPrinter: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Search-FogPrinter"></a>
# **Search-FogPrinter**
> ListPrinter200Response Search-FogPrinter<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Item] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Start] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Length] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Expand] <String><br>
...
# Search printer
try {
    $Result = Search-FogPrinter -Item $Item -Start $Start -Length $Length -Expand $Expand
} catch {
    Write-Host ("Exception occurred when calling Search-FogPrinter: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Update-FogPrinter"></a>
# **Update-FogPrinter**
> Printer Update-FogPrinter<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <Int32><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Printer] <PSCustomObject><br>
...
# Update a printer
try {
    $Result = Update-FogPrinter -Id $Id -Printer $Printer
} catch {
    Write-Host ("Exception occurred when calling Update-FogPrinter: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
