# FogApi.FogApi\Api.FogUserApi

All URIs are relative to *https://fog.example.invalid/fog*

Method | HTTP request | Description
------------- | ------------- | -------------
[**Invoke-FogCountUser**](FogUserApi.md#Invoke-FogCountUser) | **GET** /user/count | Count user
[**New-FogUser**](FogUserApi.md#New-FogUser) | **POST** /user | Create a user
[**Invoke-FogDeleteUser**](FogUserApi.md#Invoke-FogDeleteUser) | **DELETE** /user/{id} | Delete a user
[**Invoke-FogIdsUser**](FogUserApi.md#Invoke-FogIdsUser) | **GET** /user/ids | Ids for user
[**ConvertTo-FogdivUser**](FogUserApi.md#ConvertTo-FogdivUser) | **GET** /user/{id} | Get one user by id
[**Join-FogUser**](FogUserApi.md#Join-FogUser) | **PUT** /user/join | Bulk edit user
[**Invoke-FogListUser**](FogUserApi.md#Invoke-FogListUser) | **GET** /user | List user
[**Move-FogsUser**](FogUserApi.md#Move-FogsUser) | **GET** /user/names | Id and name pairs for user
[**Search-FogUser**](FogUserApi.md#Search-FogUser) | **GET** /user/search/{item} | Search user
[**Update-FogUser**](FogUserApi.md#Update-FogUser) | **PUT** /user/{id} | Update a user


<a id="Invoke-FogCountUser"></a>
# **Invoke-FogCountUser**
> CountFiledeletequeue200Response Invoke-FogCountUser<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Filter] <String><br>
...
# Count user
try {
    $Result = Invoke-FogCountUser -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogCountUser: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
...
$User = Initialize-User -Id 0 -Name "MyName" -Password "MyPassword" -Type 0 -Display "MyDisplay" -Api "0" -Token "MyToken" -Authsource "MyAuthsource" -Apionly "0" # User | 

# Create a user
try {
    $Result = New-FogUser -User $User
} catch {
    Write-Host ("Exception occurred when calling New-FogUser: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Invoke-FogDeleteUser"></a>
# **Invoke-FogDeleteUser**
> DeleteFiledeletequeue200Response Invoke-FogDeleteUser<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <Int32><br>
...
# Delete a user
try {
    $Result = Invoke-FogDeleteUser -Id $Id
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogDeleteUser: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Invoke-FogIdsUser"></a>
# **Invoke-FogIdsUser**
> SystemCollectionsHashtable[] Invoke-FogIdsUser<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Filter] <String><br>
...
# Ids for user
try {
    $Result = Invoke-FogIdsUser -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogIdsUser: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="ConvertTo-FogdivUser"></a>
# **ConvertTo-FogdivUser**
> User ConvertTo-FogdivUser<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <Int32><br>
...
# Get one user by id
try {
    $Result = ConvertTo-FogdivUser -Id $Id
} catch {
    Write-Host ("Exception occurred when calling ConvertTo-FogdivUser: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Join-FogUser"></a>
# **Join-FogUser**
> void Join-FogUser<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-JoinUserRequest] <PSCustomObject><br>
...
$JoinUserRequest = Initialize-JoinUserRequest -Id 0 -Name "MyName" -Password "MyPassword" -Type 0 -Display "MyDisplay" -Api "0" -Token "MyToken" -Authsource "MyAuthsource" -Apionly "0" -Ids 0 # JoinUserRequest | 

# Bulk edit user
try {
    $Result = Join-FogUser -JoinUserRequest $JoinUserRequest
} catch {
    Write-Host ("Exception occurred when calling Join-FogUser: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **JoinUserRequest** | [**JoinUserRequest**](JoinUserRequest.md)|  | 
...
<a id="Invoke-FogListUser"></a>
# **Invoke-FogListUser**
> ListUser200Response Invoke-FogListUser<br>
...
# List user
try {
    $Result = Invoke-FogListUser -Start $Start -Length $Length -Expand $Expand -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogListUser: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
[**ListUser200Response**](ListUser200Response.md) (PSCustomObject)
...
<a id="Move-FogsUser"></a>
# **Move-FogsUser**
> SystemCollectionsHashtable[] Move-FogsUser<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Filter] <String><br>

Id and name pairs for user
...
# Id and name pairs for user
try {
    $Result = Move-FogsUser -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Move-FogsUser: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Search-FogUser"></a>
# **Search-FogUser**
> ListUser200Response Search-FogUser<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Item] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Start] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Length] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Expand] <String><br>
...
# Search user
try {
    $Result = Search-FogUser -Item $Item -Start $Start -Length $Length -Expand $Expand
} catch {
    Write-Host ("Exception occurred when calling Search-FogUser: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Update-FogUser"></a>
# **Update-FogUser**
> User Update-FogUser<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <Int32><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-User] <PSCustomObject><br>
...
# Update a user
try {
    $Result = Update-FogUser -Id $Id -User $User
} catch {
    Write-Host ("Exception occurred when calling Update-FogUser: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
