...
------------- | ------------- | -------------
[**Invoke-FogActiveSnapintask**](FogSnapintaskApi.md#Invoke-FogActiveSnapintask) | **GET** /snapintask/current | Active snapintask
[**Stop-FogSnapintask**](FogSnapintaskApi.md#Stop-FogSnapintask) | **DELETE** /snapintask/{id}/cancel | Cancel a snapintask task
[**Invoke-FogCountSnapintask**](FogSnapintaskApi.md#Invoke-FogCountSnapintask) | **GET** /snapintask/count | Count snapintask
[**New-FogSnapintask**](FogSnapintaskApi.md#New-FogSnapintask) | **POST** /snapintask | Create a snapintask
[**Invoke-FogDeleteSnapintask**](FogSnapintaskApi.md#Invoke-FogDeleteSnapintask) | **DELETE** /snapintask/{id} | Delete a snapintask
[**Invoke-FogIdsSnapintask**](FogSnapintaskApi.md#Invoke-FogIdsSnapintask) | **GET** /snapintask/ids | Ids for snapintask
[**ConvertTo-FogdivSnapintask**](FogSnapintaskApi.md#ConvertTo-FogdivSnapintask) | **GET** /snapintask/{id} | Get one snapintask by id
[**Join-FogSnapintask**](FogSnapintaskApi.md#Join-FogSnapintask) | **PUT** /snapintask/join | Bulk edit snapintask
[**Invoke-FogListSnapintask**](FogSnapintaskApi.md#Invoke-FogListSnapintask) | **GET** /snapintask | List snapintask
[**Move-FogsSnapintask**](FogSnapintaskApi.md#Move-FogsSnapintask) | **GET** /snapintask/names | Id and name pairs for snapintask
[**Invoke-FogTaskSnapintask**](FogSnapintaskApi.md#Invoke-FogTaskSnapintask) | **POST** /snapintask/{id}/task | Queue a task against a snapintask
[**Update-FogSnapintask**](FogSnapintaskApi.md#Update-FogSnapintask) | **PUT** /snapintask/{id} | Update a snapintask


<a id="Invoke-FogActiveSnapintask"></a>
# **Invoke-FogActiveSnapintask**
> ListSnapintask200Response Invoke-FogActiveSnapintask<br>
...
# Active snapintask
try {
    $Result = Invoke-FogActiveSnapintask
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogActiveSnapintask: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
...
[**ListSnapintask200Response**](ListSnapintask200Response.md) (PSCustomObject)
...
<a id="Stop-FogSnapintask"></a>
# **Stop-FogSnapintask**
> DeleteFiledeletequeue200Response Stop-FogSnapintask<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <Int32><br>

Cancel a snapintask task
...
# Cancel a snapintask task
try {
    $Result = Stop-FogSnapintask -Id $Id
} catch {
    Write-Host ("Exception occurred when calling Stop-FogSnapintask: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Invoke-FogCountSnapintask"></a>
# **Invoke-FogCountSnapintask**
> CountFiledeletequeue200Response Invoke-FogCountSnapintask<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Filter] <String><br>
...
# Count snapintask
try {
    $Result = Invoke-FogCountSnapintask -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogCountSnapintask: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="New-FogSnapintask"></a>
# **New-FogSnapintask**
> Snapintask New-FogSnapintask<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Snapintask] <PSCustomObject><br>
...
# Create a snapintask
try {
    $Result = New-FogSnapintask -Snapintask $Snapintask
} catch {
    Write-Host ("Exception occurred when calling New-FogSnapintask: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **Snapintask** | [**Snapintask**](Snapintask.md)|  | 

### Return type

[**Snapintask**](Snapintask.md) (PSCustomObject)
...
<a id="Invoke-FogDeleteSnapintask"></a>
# **Invoke-FogDeleteSnapintask**
> DeleteFiledeletequeue200Response Invoke-FogDeleteSnapintask<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <Int32><br>
...
# Delete a snapintask
try {
    $Result = Invoke-FogDeleteSnapintask -Id $Id
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogDeleteSnapintask: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Invoke-FogIdsSnapintask"></a>
# **Invoke-FogIdsSnapintask**
> SystemCollectionsHashtable[] Invoke-FogIdsSnapintask<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Filter] <String><br>
...
# Ids for snapintask
try {
    $Result = Invoke-FogIdsSnapintask -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogIdsSnapintask: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="ConvertTo-FogdivSnapintask"></a>
# **ConvertTo-FogdivSnapintask**
> Snapintask ConvertTo-FogdivSnapintask<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <Int32><br>
...
# Get one snapintask by id
try {
    $Result = ConvertTo-FogdivSnapintask -Id $Id
} catch {
    Write-Host ("Exception occurred when calling ConvertTo-FogdivSnapintask: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Join-FogSnapintask"></a>
# **Join-FogSnapintask**
> void Join-FogSnapintask<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-JoinSnapintaskRequest] <PSCustomObject><br>
...
# Bulk edit snapintask
try {
    $Result = Join-FogSnapintask -JoinSnapintaskRequest $JoinSnapintaskRequest
} catch {
    Write-Host ("Exception occurred when calling Join-FogSnapintask: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **JoinSnapintaskRequest** | [**JoinSnapintaskRequest**](JoinSnapintaskRequest.md)|  | 
...
<a id="Invoke-FogListSnapintask"></a>
# **Invoke-FogListSnapintask**
> ListSnapintask200Response Invoke-FogListSnapintask<br>
...
# List snapintask
try {
    $Result = Invoke-FogListSnapintask -Start $Start -Length $Length -Expand $Expand -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogListSnapintask: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Move-FogsSnapintask"></a>
# **Move-FogsSnapintask**
> SystemCollectionsHashtable[] Move-FogsSnapintask<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Filter] <String><br>

Id and name pairs for snapintask
...
# Id and name pairs for snapintask
try {
    $Result = Move-FogsSnapintask -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Move-FogsSnapintask: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Invoke-FogTaskSnapintask"></a>
# **Invoke-FogTaskSnapintask**
> ListEnvelope Invoke-FogTaskSnapintask<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <Int32><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-TaskFiledeletequeueRequest] <PSCustomObject><br>

Queue a task against a snapintask
...
# Queue a task against a snapintask
try {
    $Result = Invoke-FogTaskSnapintask -Id $Id -TaskFiledeletequeueRequest $TaskFiledeletequeueRequest
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogTaskSnapintask: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Update-FogSnapintask"></a>
# **Update-FogSnapintask**
> Snapintask Update-FogSnapintask<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <Int32><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Snapintask] <PSCustomObject><br>
...
# Update a snapintask
try {
    $Result = Update-FogSnapintask -Id $Id -Snapintask $Snapintask
} catch {
    Write-Host ("Exception occurred when calling Update-FogSnapintask: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
