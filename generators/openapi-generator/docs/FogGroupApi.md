...
------------- | ------------- | -------------
[**Stop-FogGroup**](FogGroupApi.md#Stop-FogGroup) | **DELETE** /group/{id}/cancel | Cancel a group task
[**Invoke-FogCountGroup**](FogGroupApi.md#Invoke-FogCountGroup) | **GET** /group/count | Count group
[**New-FogGroup**](FogGroupApi.md#New-FogGroup) | **POST** /group | Create a group
[**Invoke-FogDeleteGroup**](FogGroupApi.md#Invoke-FogDeleteGroup) | **DELETE** /group/{id} | Delete a group
[**Invoke-FogIdsGroup**](FogGroupApi.md#Invoke-FogIdsGroup) | **GET** /group/ids | Ids for group
[**ConvertTo-FogdivGroup**](FogGroupApi.md#ConvertTo-FogdivGroup) | **GET** /group/{id} | Get one group by id
[**Join-FogByNameGroup**](FogGroupApi.md#Join-FogByNameGroup) | **POST** /group/join | Get or create group by name
[**Join-FogGroup**](FogGroupApi.md#Join-FogGroup) | **PUT** /group/join | Bulk edit group
[**Invoke-FogListGroup**](FogGroupApi.md#Invoke-FogListGroup) | **GET** /group | List group
[**Move-FogsGroup**](FogGroupApi.md#Move-FogsGroup) | **GET** /group/names | Id and name pairs for group
[**Search-FogGroup**](FogGroupApi.md#Search-FogGroup) | **GET** /group/search/{item} | Search group
[**Invoke-FogTaskGroup**](FogGroupApi.md#Invoke-FogTaskGroup) | **POST** /group/{id}/task | Queue a task against a group
[**Update-FogGroup**](FogGroupApi.md#Update-FogGroup) | **PUT** /group/{id} | Update a group


<a id="Stop-FogGroup"></a>
# **Stop-FogGroup**
> DeleteFiledeletequeue200Response Stop-FogGroup<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <Int32><br>
...
# Cancel a group task
try {
    $Result = Stop-FogGroup -Id $Id
} catch {
    Write-Host ("Exception occurred when calling Stop-FogGroup: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
...
<a id="Invoke-FogCountGroup"></a>
# **Invoke-FogCountGroup**
> CountFiledeletequeue200Response Invoke-FogCountGroup<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Filter] <String><br>
...
# Count group
try {
    $Result = Invoke-FogCountGroup -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogCountGroup: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
# Create a group
try {
    $Result = New-FogGroup -Group $Group
} catch {
    Write-Host ("Exception occurred when calling New-FogGroup: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Invoke-FogDeleteGroup"></a>
# **Invoke-FogDeleteGroup**
> DeleteFiledeletequeue200Response Invoke-FogDeleteGroup<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <Int32><br>
...
# Delete a group
try {
    $Result = Invoke-FogDeleteGroup -Id $Id
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogDeleteGroup: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Invoke-FogIdsGroup"></a>
# **Invoke-FogIdsGroup**
> SystemCollectionsHashtable[] Invoke-FogIdsGroup<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Filter] <String><br>
...
# Ids for group
try {
    $Result = Invoke-FogIdsGroup -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogIdsGroup: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="ConvertTo-FogdivGroup"></a>
# **ConvertTo-FogdivGroup**
> Group ConvertTo-FogdivGroup<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <Int32><br>
...
# Get one group by id
try {
    $Result = ConvertTo-FogdivGroup -Id $Id
} catch {
    Write-Host ("Exception occurred when calling ConvertTo-FogdivGroup: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Join-FogByNameGroup"></a>
# **Join-FogByNameGroup**
> Int32[] Join-FogByNameGroup<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-JoinByNameGroupRequest] <PSCustomObject><br>

Get or create group by name

Takes a list of names and returns an id for each: the existing object where the name is already taken, a newly created one otherwise. That pattern is often called an upsert -- update or insert -- and because the object may not exist yet it matches on the name rather than on an id. Safe to send repeatedly: the same names give the same ids back and no duplicates are made. Group only; every other class answers 400.
...
$JoinByNameGroupRequest = Initialize-JoinByNameGroupRequest -Names "MyNames" # JoinByNameGroupRequest | 

# Get or create group by name
try {
    $Result = Join-FogByNameGroup -JoinByNameGroupRequest $JoinByNameGroupRequest
} catch {
    Write-Host ("Exception occurred when calling Join-FogByNameGroup: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **JoinByNameGroupRequest** | [**JoinByNameGroupRequest**](JoinByNameGroupRequest.md)|  | 
...
<a id="Join-FogGroup"></a>
# **Join-FogGroup**
> void Join-FogGroup<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-JoinGroupRequest] <PSCustomObject><br>
...
# Bulk edit group
try {
    $Result = Join-FogGroup -JoinGroupRequest $JoinGroupRequest
} catch {
    Write-Host ("Exception occurred when calling Join-FogGroup: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Invoke-FogListGroup"></a>
# **Invoke-FogListGroup**
> ListGroup200Response Invoke-FogListGroup<br>
...
# List group
try {
    $Result = Invoke-FogListGroup -Start $Start -Length $Length -Expand $Expand -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogListGroup: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
[**ListGroup200Response**](ListGroup200Response.md) (PSCustomObject)
...
<a id="Move-FogsGroup"></a>
# **Move-FogsGroup**
> SystemCollectionsHashtable[] Move-FogsGroup<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Filter] <String><br>

Id and name pairs for group
...
# Id and name pairs for group
try {
    $Result = Move-FogsGroup -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Move-FogsGroup: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Search-FogGroup"></a>
# **Search-FogGroup**
> ListGroup200Response Search-FogGroup<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Item] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Start] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Length] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Expand] <String><br>
...
# Search group
try {
    $Result = Search-FogGroup -Item $Item -Start $Start -Length $Length -Expand $Expand
} catch {
    Write-Host ("Exception occurred when calling Search-FogGroup: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Invoke-FogTaskGroup"></a>
# **Invoke-FogTaskGroup**
> ListEnvelope Invoke-FogTaskGroup<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <Int32><br>
...
# Queue a task against a group
try {
    $Result = Invoke-FogTaskGroup -Id $Id -TaskFiledeletequeueRequest $TaskFiledeletequeueRequest
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogTaskGroup: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Update-FogGroup"></a>
# **Update-FogGroup**
> Group Update-FogGroup<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <Int32><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Group] <PSCustomObject><br>
...
# Update a group
try {
    $Result = Update-FogGroup -Id $Id -Group $Group
} catch {
    Write-Host ("Exception occurred when calling Update-FogGroup: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
