# FogApi.FogApi\Api.FogSiteApi

All URIs are relative to *https://fog.example.invalid/fog*

Method | HTTP request | Description
------------- | ------------- | -------------
[**Invoke-FogCountSite**](FogSiteApi.md#Invoke-FogCountSite) | **GET** /site/count | Count site
[**New-FogSite**](FogSiteApi.md#New-FogSite) | **POST** /site | Create a site
[**Invoke-FogDeleteSite**](FogSiteApi.md#Invoke-FogDeleteSite) | **DELETE** /site/{id} | Delete a site
[**Invoke-FogIdsSite**](FogSiteApi.md#Invoke-FogIdsSite) | **GET** /site/ids | Ids for site
[**ConvertTo-FogdivSite**](FogSiteApi.md#ConvertTo-FogdivSite) | **GET** /site/{id} | Get one site by id
[**Join-FogSite**](FogSiteApi.md#Join-FogSite) | **PUT** /site/join | Bulk edit site
[**Invoke-FogListSite**](FogSiteApi.md#Invoke-FogListSite) | **GET** /site | List site
[**Move-FogsSite**](FogSiteApi.md#Move-FogsSite) | **GET** /site/names | Id and name pairs for site
[**Search-FogSite**](FogSiteApi.md#Search-FogSite) | **GET** /site/search/{item} | Search site
[**Update-FogSite**](FogSiteApi.md#Update-FogSite) | **PUT** /site/{id} | Update a site


<a id="Invoke-FogCountSite"></a>
# **Invoke-FogCountSite**
> CountFiledeletequeue200Response Invoke-FogCountSite<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Filter] <String><br>
...
# Count site
try {
    $Result = Invoke-FogCountSite -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogCountSite: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
...
$Site = Initialize-Site -Id 0 -Name "MyName" -Description "MyDescription" # Site | 

# Create a site
try {
    $Result = New-FogSite -Site $Site
} catch {
    Write-Host ("Exception occurred when calling New-FogSite: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Invoke-FogDeleteSite"></a>
# **Invoke-FogDeleteSite**
> DeleteFiledeletequeue200Response Invoke-FogDeleteSite<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <Int32><br>
...
# Delete a site
try {
    $Result = Invoke-FogDeleteSite -Id $Id
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogDeleteSite: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Invoke-FogIdsSite"></a>
# **Invoke-FogIdsSite**
> SystemCollectionsHashtable[] Invoke-FogIdsSite<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Filter] <String><br>
...
# Ids for site
try {
    $Result = Invoke-FogIdsSite -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogIdsSite: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="ConvertTo-FogdivSite"></a>
# **ConvertTo-FogdivSite**
> Site ConvertTo-FogdivSite<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <Int32><br>
...
# Get one site by id
try {
    $Result = ConvertTo-FogdivSite -Id $Id
} catch {
    Write-Host ("Exception occurred when calling ConvertTo-FogdivSite: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Join-FogSite"></a>
# **Join-FogSite**
> void Join-FogSite<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-JoinSiteRequest] <PSCustomObject><br>
...
$JoinSiteRequest = Initialize-JoinSiteRequest -Id 0 -Name "MyName" -Description "MyDescription" -Ids 0 # JoinSiteRequest | 

# Bulk edit site
try {
    $Result = Join-FogSite -JoinSiteRequest $JoinSiteRequest
} catch {
    Write-Host ("Exception occurred when calling Join-FogSite: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **JoinSiteRequest** | [**JoinSiteRequest**](JoinSiteRequest.md)|  | 
...
<a id="Invoke-FogListSite"></a>
# **Invoke-FogListSite**
> ListSite200Response Invoke-FogListSite<br>
...
# List site
try {
    $Result = Invoke-FogListSite -Start $Start -Length $Length -Expand $Expand -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogListSite: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
[**ListSite200Response**](ListSite200Response.md) (PSCustomObject)
...
<a id="Move-FogsSite"></a>
# **Move-FogsSite**
> SystemCollectionsHashtable[] Move-FogsSite<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Filter] <String><br>

Id and name pairs for site
...
# Id and name pairs for site
try {
    $Result = Move-FogsSite -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Move-FogsSite: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Search-FogSite"></a>
# **Search-FogSite**
> ListSite200Response Search-FogSite<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Item] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Start] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Length] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Expand] <String><br>
...
# Search site
try {
    $Result = Search-FogSite -Item $Item -Start $Start -Length $Length -Expand $Expand
} catch {
    Write-Host ("Exception occurred when calling Search-FogSite: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Update-FogSite"></a>
# **Update-FogSite**
> Site Update-FogSite<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <Int32><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Site] <PSCustomObject><br>
...
# Update a site
try {
    $Result = Update-FogSite -Id $Id -Site $Site
} catch {
    Write-Host ("Exception occurred when calling Update-FogSite: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
