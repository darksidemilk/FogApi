# ListGroupassociation200Response
## Properties
...
**VarData** | [**Groupassociation[]**](Groupassociation.md) |  | [optional] 
...
```powershell
$ListGroupassociation200Response = Initialize-FogApiListGroupassociation200Response  -Draw null `
 -RecordsTotal null `
...
```powershell
$ListGroupassociation200Response | ConvertTo-JSON
```
