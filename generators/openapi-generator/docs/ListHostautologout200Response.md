...
**VarData** | [**Hostautologout[]**](Hostautologout.md) |  | [optional] 
...
```powershell
$ListHostautologout200Response = Initialize-FogApiListHostautologout200Response  -Draw null `
 -RecordsTotal null `
...
```powershell
$ListHostautologout200Response | ConvertTo-JSON
```
