...
------------- | ------------- | -------------
[**Invoke-FogCountUsergroup**](FogUsergroupApi.md#Invoke-FogCountUsergroup) | **GET** /usergroup/count | Count usergroup
[**New-FogUsergroup**](FogUsergroupApi.md#New-FogUsergroup) | **POST** /usergroup | Create a usergroup
[**Invoke-FogDeleteUsergroup**](FogUsergroupApi.md#Invoke-FogDeleteUsergroup) | **DELETE** /usergroup/{id} | Delete a usergroup
[**Invoke-FogIdsUsergroup**](FogUsergroupApi.md#Invoke-FogIdsUsergroup) | **GET** /usergroup/ids | Ids for usergroup
[**ConvertTo-FogdivUsergroup**](FogUsergroupApi.md#ConvertTo-FogdivUsergroup) | **GET** /usergroup/{id} | Get one usergroup by id
[**Join-FogUsergroup**](FogUsergroupApi.md#Join-FogUsergroup) | **PUT** /usergroup/join | Bulk edit usergroup
[**Invoke-FogListUsergroup**](FogUsergroupApi.md#Invoke-FogListUsergroup) | **GET** /usergroup | List usergroup
[**Move-FogsUsergroup**](FogUsergroupApi.md#Move-FogsUsergroup) | **GET** /usergroup/names | Id and name pairs for usergroup
[**Search-FogUsergroup**](FogUsergroupApi.md#Search-FogUsergroup) | **GET** /usergroup/search/{item} | Search usergroup
[**Update-FogUsergroup**](FogUsergroupApi.md#Update-FogUsergroup) | **PUT** /usergroup/{id} | Update a usergroup


<a id="Invoke-FogCountUsergroup"></a>
# **Invoke-FogCountUsergroup**
> CountFiledeletequeue200Response Invoke-FogCountUsergroup<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Filter] <String><br>
...
# Count usergroup
try {
    $Result = Invoke-FogCountUsergroup -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogCountUsergroup: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
...
<a id="New-FogUsergroup"></a>
# **New-FogUsergroup**
> Usergroup New-FogUsergroup<br>
...
# Create a usergroup
try {
    $Result = New-FogUsergroup -Usergroup $Usergroup
} catch {
    Write-Host ("Exception occurred when calling New-FogUsergroup: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Invoke-FogDeleteUsergroup"></a>
# **Invoke-FogDeleteUsergroup**
> DeleteFiledeletequeue200Response Invoke-FogDeleteUsergroup<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <Int32><br>
...
# Delete a usergroup
try {
    $Result = Invoke-FogDeleteUsergroup -Id $Id
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogDeleteUsergroup: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Invoke-FogIdsUsergroup"></a>
# **Invoke-FogIdsUsergroup**
> SystemCollectionsHashtable[] Invoke-FogIdsUsergroup<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Filter] <String><br>
...
# Ids for usergroup
try {
    $Result = Invoke-FogIdsUsergroup -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogIdsUsergroup: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="ConvertTo-FogdivUsergroup"></a>
# **ConvertTo-FogdivUsergroup**
> Usergroup ConvertTo-FogdivUsergroup<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <Int32><br>
...
# Get one usergroup by id
try {
    $Result = ConvertTo-FogdivUsergroup -Id $Id
} catch {
    Write-Host ("Exception occurred when calling ConvertTo-FogdivUsergroup: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Join-FogUsergroup"></a>
# **Join-FogUsergroup**
> void Join-FogUsergroup<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-JoinUsergroupRequest] <PSCustomObject><br>
...
# Bulk edit usergroup
try {
    $Result = Join-FogUsergroup -JoinUsergroupRequest $JoinUsergroupRequest
} catch {
    Write-Host ("Exception occurred when calling Join-FogUsergroup: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **JoinUsergroupRequest** | [**JoinUsergroupRequest**](JoinUsergroupRequest.md)|  | 
...
<a id="Invoke-FogListUsergroup"></a>
# **Invoke-FogListUsergroup**
> ListUsergroup200Response Invoke-FogListUsergroup<br>
...
# List usergroup
try {
    $Result = Invoke-FogListUsergroup -Start $Start -Length $Length -Expand $Expand -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogListUsergroup: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
[**ListUsergroup200Response**](ListUsergroup200Response.md) (PSCustomObject)
...
<a id="Move-FogsUsergroup"></a>
# **Move-FogsUsergroup**
> SystemCollectionsHashtable[] Move-FogsUsergroup<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Filter] <String><br>

Id and name pairs for usergroup
...
# Id and name pairs for usergroup
try {
    $Result = Move-FogsUsergroup -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Move-FogsUsergroup: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Search-FogUsergroup"></a>
# **Search-FogUsergroup**
> ListUsergroup200Response Search-FogUsergroup<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Item] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Start] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Length] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Expand] <String><br>
...
# Search usergroup
try {
    $Result = Search-FogUsergroup -Item $Item -Start $Start -Length $Length -Expand $Expand
} catch {
    Write-Host ("Exception occurred when calling Search-FogUsergroup: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Update-FogUsergroup"></a>
# **Update-FogUsergroup**
> Usergroup Update-FogUsergroup<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <Int32><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Usergroup] <PSCustomObject><br>
...
# Update a usergroup
try {
    $Result = Update-FogUsergroup -Id $Id -Usergroup $Usergroup
} catch {
    Write-Host ("Exception occurred when calling Update-FogUsergroup: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
