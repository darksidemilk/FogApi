# ListMacaddressassociation200Response
## Properties
...
**VarData** | [**Macaddressassociation[]**](Macaddressassociation.md) |  | [optional] 
...
```powershell
$ListMacaddressassociation200Response = Initialize-FogApiListMacaddressassociation200Response  -Draw null `
 -RecordsTotal null `
...
```powershell
$ListMacaddressassociation200Response | ConvertTo-JSON
```
