# ListImageassociation200Response
## Properties
...
**VarData** | [**Imageassociation[]**](Imageassociation.md) |  | [optional] 
...
```powershell
$ListImageassociation200Response = Initialize-FogApiListImageassociation200Response  -Draw null `
 -RecordsTotal null `
...
```powershell
$ListImageassociation200Response | ConvertTo-JSON
```
