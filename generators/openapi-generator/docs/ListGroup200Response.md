...
**VarData** | [**Group[]**](Group.md) |  | [optional] 
...
```powershell
$ListGroup200Response = Initialize-FogApiListGroup200Response  -Draw null `
 -RecordsTotal null `
...
```powershell
$ListGroup200Response | ConvertTo-JSON
```
