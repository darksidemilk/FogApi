...
**VarData** | [**Ldapgroup[]**](Ldapgroup.md) |  | [optional] 
...
```powershell
$ListLdapgroup200Response = Initialize-FogApiListLdapgroup200Response  -Draw null `
 -RecordsTotal null `
...
```powershell
$ListLdapgroup200Response | ConvertTo-JSON
```
