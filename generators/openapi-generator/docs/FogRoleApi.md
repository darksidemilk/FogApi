# FogApi.FogApi\Api.FogRoleApi

All URIs are relative to *https://fog.example.invalid/fog*

Method | HTTP request | Description
------------- | ------------- | -------------
[**Invoke-FogCountRole**](FogRoleApi.md#Invoke-FogCountRole) | **GET** /role/count | Count role
[**New-FogRole**](FogRoleApi.md#New-FogRole) | **POST** /role | Create a role
[**Invoke-FogDeleteRole**](FogRoleApi.md#Invoke-FogDeleteRole) | **DELETE** /role/{id} | Delete a role
[**Invoke-FogIdsRole**](FogRoleApi.md#Invoke-FogIdsRole) | **GET** /role/ids | Ids for role
[**ConvertTo-FogdivRole**](FogRoleApi.md#ConvertTo-FogdivRole) | **GET** /role/{id} | Get one role by id
[**Join-FogRole**](FogRoleApi.md#Join-FogRole) | **PUT** /role/join | Bulk edit role
[**Invoke-FogListRole**](FogRoleApi.md#Invoke-FogListRole) | **GET** /role | List role
[**Move-FogsRole**](FogRoleApi.md#Move-FogsRole) | **GET** /role/names | Id and name pairs for role
[**Search-FogRole**](FogRoleApi.md#Search-FogRole) | **GET** /role/search/{item} | Search role
[**Update-FogRole**](FogRoleApi.md#Update-FogRole) | **PUT** /role/{id} | Update a role


<a id="Invoke-FogCountRole"></a>
# **Invoke-FogCountRole**
> CountFiledeletequeue200Response Invoke-FogCountRole<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Filter] <String><br>
...
# Count role
try {
    $Result = Invoke-FogCountRole -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogCountRole: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
...
$Role = Initialize-Role -Id 0 -Name "MyName" -Description "MyDescription" # Role | 

# Create a role
try {
    $Result = New-FogRole -Role $Role
} catch {
    Write-Host ("Exception occurred when calling New-FogRole: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Invoke-FogDeleteRole"></a>
# **Invoke-FogDeleteRole**
> DeleteFiledeletequeue200Response Invoke-FogDeleteRole<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <Int32><br>
...
# Delete a role
try {
    $Result = Invoke-FogDeleteRole -Id $Id
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogDeleteRole: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Invoke-FogIdsRole"></a>
# **Invoke-FogIdsRole**
> SystemCollectionsHashtable[] Invoke-FogIdsRole<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Filter] <String><br>
...
# Ids for role
try {
    $Result = Invoke-FogIdsRole -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogIdsRole: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="ConvertTo-FogdivRole"></a>
# **ConvertTo-FogdivRole**
> Role ConvertTo-FogdivRole<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <Int32><br>
...
# Get one role by id
try {
    $Result = ConvertTo-FogdivRole -Id $Id
} catch {
    Write-Host ("Exception occurred when calling ConvertTo-FogdivRole: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Join-FogRole"></a>
# **Join-FogRole**
> void Join-FogRole<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-JoinRoleRequest] <PSCustomObject><br>
...
$JoinRoleRequest = Initialize-JoinRoleRequest -Id 0 -Name "MyName" -Description "MyDescription" -Ids 0 # JoinRoleRequest | 

# Bulk edit role
try {
    $Result = Join-FogRole -JoinRoleRequest $JoinRoleRequest
} catch {
    Write-Host ("Exception occurred when calling Join-FogRole: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **JoinRoleRequest** | [**JoinRoleRequest**](JoinRoleRequest.md)|  | 
...
<a id="Invoke-FogListRole"></a>
# **Invoke-FogListRole**
> ListRole200Response Invoke-FogListRole<br>
...
# List role
try {
    $Result = Invoke-FogListRole -Start $Start -Length $Length -Expand $Expand -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogListRole: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
[**ListRole200Response**](ListRole200Response.md) (PSCustomObject)
...
<a id="Move-FogsRole"></a>
# **Move-FogsRole**
> SystemCollectionsHashtable[] Move-FogsRole<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Filter] <String><br>

Id and name pairs for role
...
# Id and name pairs for role
try {
    $Result = Move-FogsRole -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Move-FogsRole: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Search-FogRole"></a>
# **Search-FogRole**
> ListRole200Response Search-FogRole<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Item] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Start] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Length] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Expand] <String><br>
...
# Search role
try {
    $Result = Search-FogRole -Item $Item -Start $Start -Length $Length -Expand $Expand
} catch {
    Write-Host ("Exception occurred when calling Search-FogRole: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Update-FogRole"></a>
# **Update-FogRole**
> Role Update-FogRole<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <Int32><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Role] <PSCustomObject><br>
...
# Update a role
try {
    $Result = Update-FogRole -Id $Id -Role $Role
} catch {
    Write-Host ("Exception occurred when calling Update-FogRole: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
