...
**VarData** | [**Image[]**](Image.md) |  | [optional] 
...
```powershell
$ListImage200Response = Initialize-FogApiListImage200Response  -Draw null `
 -RecordsTotal null `
...
```powershell
$ListImage200Response | ConvertTo-JSON
```
