...
**VarData** | [**Printer[]**](Printer.md) |  | [optional] 
...
```powershell
$ListPrinter200Response = Initialize-FogApiListPrinter200Response  -Draw null `
 -RecordsTotal null `
...
```powershell
$ListPrinter200Response | ConvertTo-JSON
```
