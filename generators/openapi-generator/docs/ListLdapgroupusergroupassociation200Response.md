# ListLdapgroupusergroupassociation200Response
## Properties
...
**VarData** | [**Ldapgroupusergroupassociation[]**](Ldapgroupusergroupassociation.md) |  | [optional] 
...
```powershell
$ListLdapgroupusergroupassociation200Response = Initialize-FogApiListLdapgroupusergroupassociation200Response  -Draw null `
 -RecordsTotal null `
...
```powershell
$ListLdapgroupusergroupassociation200Response | ConvertTo-JSON
```
