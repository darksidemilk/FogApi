...
**VarData** | [**Plugin[]**](Plugin.md) |  | [optional] 
...
```powershell
$ListPlugin200Response = Initialize-FogApiListPlugin200Response  -Draw null `
 -RecordsTotal null `
...
```powershell
$ListPlugin200Response | ConvertTo-JSON
```
