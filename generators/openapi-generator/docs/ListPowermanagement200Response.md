...
**VarData** | [**Powermanagement[]**](Powermanagement.md) |  | [optional] 
...
```powershell
$ListPowermanagement200Response = Initialize-FogApiListPowermanagement200Response  -Draw null `
 -RecordsTotal null `
...
```powershell
$ListPowermanagement200Response | ConvertTo-JSON
```
