...
**VarData** | [**Usergroup[]**](Usergroup.md) |  | [optional] 
...
```powershell
$ListUsergroup200Response = Initialize-FogApiListUsergroup200Response  -Draw null `
 -RecordsTotal null `
...
```powershell
$ListUsergroup200Response | ConvertTo-JSON
```
