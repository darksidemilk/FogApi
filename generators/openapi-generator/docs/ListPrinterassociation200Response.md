# ListPrinterassociation200Response
## Properties
...
**VarData** | [**Printerassociation[]**](Printerassociation.md) |  | [optional] 
...
```powershell
$ListPrinterassociation200Response = Initialize-FogApiListPrinterassociation200Response  -Draw null `
 -RecordsTotal null `
...
```powershell
$ListPrinterassociation200Response | ConvertTo-JSON
```
