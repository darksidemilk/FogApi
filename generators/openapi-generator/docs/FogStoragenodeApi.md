...
------------- | ------------- | -------------
[**Invoke-FogCountStoragenode**](FogStoragenodeApi.md#Invoke-FogCountStoragenode) | **GET** /storagenode/count | Count storagenode
[**New-FogStoragenode**](FogStoragenodeApi.md#New-FogStoragenode) | **POST** /storagenode | Create a storagenode
[**Invoke-FogDeleteStoragenode**](FogStoragenodeApi.md#Invoke-FogDeleteStoragenode) | **DELETE** /storagenode/{id} | Delete a storagenode
[**Invoke-FogIdsStoragenode**](FogStoragenodeApi.md#Invoke-FogIdsStoragenode) | **GET** /storagenode/ids | Ids for storagenode
[**ConvertTo-FogdivStoragenode**](FogStoragenodeApi.md#ConvertTo-FogdivStoragenode) | **GET** /storagenode/{id} | Get one storagenode by id
[**Join-FogStoragenode**](FogStoragenodeApi.md#Join-FogStoragenode) | **PUT** /storagenode/join | Bulk edit storagenode
[**Invoke-FogListStoragenode**](FogStoragenodeApi.md#Invoke-FogListStoragenode) | **GET** /storagenode | List storagenode
[**Move-FogsStoragenode**](FogStoragenodeApi.md#Move-FogsStoragenode) | **GET** /storagenode/names | Id and name pairs for storagenode
[**Search-FogStoragenode**](FogStoragenodeApi.md#Search-FogStoragenode) | **GET** /storagenode/search/{item} | Search storagenode
[**Update-FogStoragenode**](FogStoragenodeApi.md#Update-FogStoragenode) | **PUT** /storagenode/{id} | Update a storagenode


<a id="Invoke-FogCountStoragenode"></a>
# **Invoke-FogCountStoragenode**
> CountFiledeletequeue200Response Invoke-FogCountStoragenode<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Filter] <String><br>
...
# Count storagenode
try {
    $Result = Invoke-FogCountStoragenode -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogCountStoragenode: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
...
<a id="New-FogStoragenode"></a>
# **New-FogStoragenode**
> Storagenode New-FogStoragenode<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Storagenode] <PSCustomObject><br>
...
# Create a storagenode
try {
    $Result = New-FogStoragenode -Storagenode $Storagenode
} catch {
    Write-Host ("Exception occurred when calling New-FogStoragenode: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **Storagenode** | [**Storagenode**](Storagenode.md)|  | 

### Return type

[**Storagenode**](Storagenode.md) (PSCustomObject)
...
<a id="Invoke-FogDeleteStoragenode"></a>
# **Invoke-FogDeleteStoragenode**
> DeleteFiledeletequeue200Response Invoke-FogDeleteStoragenode<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <Int32><br>
...
# Delete a storagenode
try {
    $Result = Invoke-FogDeleteStoragenode -Id $Id
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogDeleteStoragenode: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Invoke-FogIdsStoragenode"></a>
# **Invoke-FogIdsStoragenode**
> SystemCollectionsHashtable[] Invoke-FogIdsStoragenode<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Filter] <String><br>
...
# Ids for storagenode
try {
    $Result = Invoke-FogIdsStoragenode -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogIdsStoragenode: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="ConvertTo-FogdivStoragenode"></a>
# **ConvertTo-FogdivStoragenode**
> Storagenode ConvertTo-FogdivStoragenode<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <Int32><br>
...
# Get one storagenode by id
try {
    $Result = ConvertTo-FogdivStoragenode -Id $Id
} catch {
    Write-Host ("Exception occurred when calling ConvertTo-FogdivStoragenode: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Join-FogStoragenode"></a>
# **Join-FogStoragenode**
> void Join-FogStoragenode<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-JoinStoragenodeRequest] <PSCustomObject><br>
...
# Bulk edit storagenode
try {
    $Result = Join-FogStoragenode -JoinStoragenodeRequest $JoinStoragenodeRequest
} catch {
    Write-Host ("Exception occurred when calling Join-FogStoragenode: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **JoinStoragenodeRequest** | [**JoinStoragenodeRequest**](JoinStoragenodeRequest.md)|  | 
...
<a id="Invoke-FogListStoragenode"></a>
# **Invoke-FogListStoragenode**
> ListStoragenode200Response Invoke-FogListStoragenode<br>
...
# List storagenode
try {
    $Result = Invoke-FogListStoragenode -Start $Start -Length $Length -Expand $Expand -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogListStoragenode: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
[**ListStoragenode200Response**](ListStoragenode200Response.md) (PSCustomObject)
...
<a id="Move-FogsStoragenode"></a>
# **Move-FogsStoragenode**
> SystemCollectionsHashtable[] Move-FogsStoragenode<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Filter] <String><br>

Id and name pairs for storagenode
...
# Id and name pairs for storagenode
try {
    $Result = Move-FogsStoragenode -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Move-FogsStoragenode: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Search-FogStoragenode"></a>
# **Search-FogStoragenode**
> ListStoragenode200Response Search-FogStoragenode<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Item] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Start] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Length] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Expand] <String><br>
...
# Search storagenode
try {
    $Result = Search-FogStoragenode -Item $Item -Start $Start -Length $Length -Expand $Expand
} catch {
    Write-Host ("Exception occurred when calling Search-FogStoragenode: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Update-FogStoragenode"></a>
# **Update-FogStoragenode**
> Storagenode Update-FogStoragenode<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <Int32><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Storagenode] <PSCustomObject><br>
...
# Update a storagenode
try {
    $Result = Update-FogStoragenode -Id $Id -Storagenode $Storagenode
} catch {
    Write-Host ("Exception occurred when calling Update-FogStoragenode: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
