...
------------- | ------------- | -------------
[**Invoke-FogActiveTask**](FogTaskApi.md#Invoke-FogActiveTask) | **GET** /task/current | Active task
[**Stop-FogTask**](FogTaskApi.md#Stop-FogTask) | **DELETE** /task/{id}/cancel | Cancel a task task
[**Invoke-FogCountTask**](FogTaskApi.md#Invoke-FogCountTask) | **GET** /task/count | Count task
[**New-FogTask**](FogTaskApi.md#New-FogTask) | **POST** /task | Create a task
[**Invoke-FogDeleteTask**](FogTaskApi.md#Invoke-FogDeleteTask) | **DELETE** /task/{id} | Delete a task
[**Invoke-FogIdsTask**](FogTaskApi.md#Invoke-FogIdsTask) | **GET** /task/ids | Ids for task
[**ConvertTo-FogdivTask**](FogTaskApi.md#ConvertTo-FogdivTask) | **GET** /task/{id} | Get one task by id
[**Join-FogTask**](FogTaskApi.md#Join-FogTask) | **PUT** /task/join | Bulk edit task
[**Invoke-FogListTask**](FogTaskApi.md#Invoke-FogListTask) | **GET** /task | List task
[**Move-FogsTask**](FogTaskApi.md#Move-FogsTask) | **GET** /task/names | Id and name pairs for task
[**Search-FogTask**](FogTaskApi.md#Search-FogTask) | **GET** /task/search/{item} | Search task
[**Invoke-FogTaskTask**](FogTaskApi.md#Invoke-FogTaskTask) | **POST** /task/{id}/task | Queue a task against a task
[**Update-FogTask**](FogTaskApi.md#Update-FogTask) | **PUT** /task/{id} | Update a task


<a id="Invoke-FogActiveTask"></a>
# **Invoke-FogActiveTask**
> ListTask200Response Invoke-FogActiveTask<br>
...
# Active task
try {
    $Result = Invoke-FogActiveTask
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogActiveTask: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
...
[**ListTask200Response**](ListTask200Response.md) (PSCustomObject)
...
<a id="Stop-FogTask"></a>
# **Stop-FogTask**
> DeleteFiledeletequeue200Response Stop-FogTask<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <Int32><br>
...
# Cancel a task task
try {
    $Result = Stop-FogTask -Id $Id
} catch {
    Write-Host ("Exception occurred when calling Stop-FogTask: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Invoke-FogCountTask"></a>
# **Invoke-FogCountTask**
> CountFiledeletequeue200Response Invoke-FogCountTask<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Filter] <String><br>
...
# Count task
try {
    $Result = Invoke-FogCountTask -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogCountTask: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
# Create a task
try {
    $Result = New-FogTask -Task $Task
} catch {
    Write-Host ("Exception occurred when calling New-FogTask: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Invoke-FogDeleteTask"></a>
# **Invoke-FogDeleteTask**
> DeleteFiledeletequeue200Response Invoke-FogDeleteTask<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <Int32><br>
...
# Delete a task
try {
    $Result = Invoke-FogDeleteTask -Id $Id
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogDeleteTask: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Invoke-FogIdsTask"></a>
# **Invoke-FogIdsTask**
> SystemCollectionsHashtable[] Invoke-FogIdsTask<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Filter] <String><br>
...
# Ids for task
try {
    $Result = Invoke-FogIdsTask -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogIdsTask: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="ConvertTo-FogdivTask"></a>
# **ConvertTo-FogdivTask**
> Task ConvertTo-FogdivTask<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <Int32><br>
...
# Get one task by id
try {
    $Result = ConvertTo-FogdivTask -Id $Id
} catch {
    Write-Host ("Exception occurred when calling ConvertTo-FogdivTask: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Join-FogTask"></a>
# **Join-FogTask**
> void Join-FogTask<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-JoinTaskRequest] <PSCustomObject><br>
...
# Bulk edit task
try {
    $Result = Join-FogTask -JoinTaskRequest $JoinTaskRequest
} catch {
    Write-Host ("Exception occurred when calling Join-FogTask: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **JoinTaskRequest** | [**JoinTaskRequest**](JoinTaskRequest.md)|  | 
...
<a id="Invoke-FogListTask"></a>
# **Invoke-FogListTask**
> ListTask200Response Invoke-FogListTask<br>
...
# List task
try {
    $Result = Invoke-FogListTask -Start $Start -Length $Length -Expand $Expand -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogListTask: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Move-FogsTask"></a>
# **Move-FogsTask**
> SystemCollectionsHashtable[] Move-FogsTask<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Filter] <String><br>
...
# Id and name pairs for task
try {
    $Result = Move-FogsTask -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Move-FogsTask: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Search-FogTask"></a>
# **Search-FogTask**
> ListTask200Response Search-FogTask<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Item] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Start] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Length] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Expand] <String><br>
...
# Search task
try {
    $Result = Search-FogTask -Item $Item -Start $Start -Length $Length -Expand $Expand
} catch {
    Write-Host ("Exception occurred when calling Search-FogTask: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Invoke-FogTaskTask"></a>
# **Invoke-FogTaskTask**
> ListEnvelope Invoke-FogTaskTask<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <Int32><br>
...
# Queue a task against a task
try {
    $Result = Invoke-FogTaskTask -Id $Id -TaskFiledeletequeueRequest $TaskFiledeletequeueRequest
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogTaskTask: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Update-FogTask"></a>
# **Update-FogTask**
> Task Update-FogTask<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <Int32><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Task] <PSCustomObject><br>
...
# Update a task
try {
    $Result = Update-FogTask -Id $Id -Task $Task
} catch {
    Write-Host ("Exception occurred when calling Update-FogTask: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
