...
**VarData** | [**Filedeletequeue[]**](Filedeletequeue.md) |  | [optional] 
...
```powershell
$ListFiledeletequeue200Response = Initialize-FogApiListFiledeletequeue200Response  -Draw null `
 -RecordsTotal null `
...
```powershell
$ListFiledeletequeue200Response | ConvertTo-JSON
```
