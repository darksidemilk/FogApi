# FogApi.FogApi\Api.FogTasklogApi

All URIs are relative to *https://fog.example.invalid/fog*

Method | HTTP request | Description
------------- | ------------- | -------------
[**Invoke-FogCountTasklog**](FogTasklogApi.md#Invoke-FogCountTasklog) | **GET** /tasklog/count | Count tasklog
[**Invoke-FogIdsTasklog**](FogTasklogApi.md#Invoke-FogIdsTasklog) | **GET** /tasklog/ids | Ids for tasklog
[**ConvertTo-FogdivTasklog**](FogTasklogApi.md#ConvertTo-FogdivTasklog) | **GET** /tasklog/{id} | Get one tasklog by id
[**Invoke-FogListTasklog**](FogTasklogApi.md#Invoke-FogListTasklog) | **GET** /tasklog | List tasklog
[**Move-FogsTasklog**](FogTasklogApi.md#Move-FogsTasklog) | **GET** /tasklog/names | Id and name pairs for tasklog


<a id="Invoke-FogCountTasklog"></a>
# **Invoke-FogCountTasklog**
> CountFiledeletequeue200Response Invoke-FogCountTasklog<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Filter] <String><br>
...
# Count tasklog
try {
    $Result = Invoke-FogCountTasklog -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogCountTasklog: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
...
<a id="Invoke-FogIdsTasklog"></a>
# **Invoke-FogIdsTasklog**
> SystemCollectionsHashtable[] Invoke-FogIdsTasklog<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Filter] <String><br>
...
# Ids for tasklog
try {
    $Result = Invoke-FogIdsTasklog -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogIdsTasklog: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="ConvertTo-FogdivTasklog"></a>
# **ConvertTo-FogdivTasklog**
> Tasklog ConvertTo-FogdivTasklog<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <Int32><br>
...
# Get one tasklog by id
try {
    $Result = ConvertTo-FogdivTasklog -Id $Id
} catch {
    Write-Host ("Exception occurred when calling ConvertTo-FogdivTasklog: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
[**Tasklog**](Tasklog.md) (PSCustomObject)
...
<a id="Invoke-FogListTasklog"></a>
# **Invoke-FogListTasklog**
> ListTasklog200Response Invoke-FogListTasklog<br>
...
# List tasklog
try {
    $Result = Invoke-FogListTasklog -Start $Start -Length $Length -Expand $Expand -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogListTasklog: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
[**ListTasklog200Response**](ListTasklog200Response.md) (PSCustomObject)
...
<a id="Move-FogsTasklog"></a>
# **Move-FogsTasklog**
> SystemCollectionsHashtable[] Move-FogsTasklog<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Filter] <String><br>

Id and name pairs for tasklog
...
# Id and name pairs for tasklog
try {
    $Result = Move-FogsTasklog -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Move-FogsTasklog: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
