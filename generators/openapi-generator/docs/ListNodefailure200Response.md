...
**VarData** | [**Nodefailure[]**](Nodefailure.md) |  | [optional] 
...
```powershell
$ListNodefailure200Response = Initialize-FogApiListNodefailure200Response  -Draw null `
 -RecordsTotal null `
...
```powershell
$ListNodefailure200Response | ConvertTo-JSON
```
