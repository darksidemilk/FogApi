...
**VarData** | [**Snapintask[]**](Snapintask.md) |  | [optional] 
...
```powershell
$ListSnapintask200Response = Initialize-FogApiListSnapintask200Response  -Draw null `
 -RecordsTotal null `
...
```powershell
$ListSnapintask200Response | ConvertTo-JSON
```
