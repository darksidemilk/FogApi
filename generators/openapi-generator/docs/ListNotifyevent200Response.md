...
**VarData** | [**Notifyevent[]**](Notifyevent.md) |  | [optional] 
...
```powershell
$ListNotifyevent200Response = Initialize-FogApiListNotifyevent200Response  -Draw null `
 -RecordsTotal null `
...
```powershell
$ListNotifyevent200Response | ConvertTo-JSON
```
