...
------------- | ------------- | -------------
[**Invoke-FogCountModule**](FogModuleApi.md#Invoke-FogCountModule) | **GET** /module/count | Count module
[**New-FogModule**](FogModuleApi.md#New-FogModule) | **POST** /module | Create a module
[**Invoke-FogDeleteModule**](FogModuleApi.md#Invoke-FogDeleteModule) | **DELETE** /module/{id} | Delete a module
[**Invoke-FogIdsModule**](FogModuleApi.md#Invoke-FogIdsModule) | **GET** /module/ids | Ids for module
[**ConvertTo-FogdivModule**](FogModuleApi.md#ConvertTo-FogdivModule) | **GET** /module/{id} | Get one module by id
[**Join-FogModule**](FogModuleApi.md#Join-FogModule) | **PUT** /module/join | Bulk edit module
[**Invoke-FogListModule**](FogModuleApi.md#Invoke-FogListModule) | **GET** /module | List module
[**Move-FogsModule**](FogModuleApi.md#Move-FogsModule) | **GET** /module/names | Id and name pairs for module
[**Search-FogModule**](FogModuleApi.md#Search-FogModule) | **GET** /module/search/{item} | Search module
[**Update-FogModule**](FogModuleApi.md#Update-FogModule) | **PUT** /module/{id} | Update a module


<a id="Invoke-FogCountModule"></a>
# **Invoke-FogCountModule**
> CountFiledeletequeue200Response Invoke-FogCountModule<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Filter] <String><br>
...
# Count module
try {
    $Result = Invoke-FogCountModule -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogCountModule: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
...
<a id="New-FogModule"></a>
# **New-FogModule**
> Module New-FogModule<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Module] <PSCustomObject><br>
...
# Create a module
try {
    $Result = New-FogModule -Module $Module
} catch {
    Write-Host ("Exception occurred when calling New-FogModule: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
[**Module**](Module.md) (PSCustomObject)
...
<a id="Invoke-FogDeleteModule"></a>
# **Invoke-FogDeleteModule**
> DeleteFiledeletequeue200Response Invoke-FogDeleteModule<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <Int32><br>
...
# Delete a module
try {
    $Result = Invoke-FogDeleteModule -Id $Id
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogDeleteModule: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Invoke-FogIdsModule"></a>
# **Invoke-FogIdsModule**
> SystemCollectionsHashtable[] Invoke-FogIdsModule<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Filter] <String><br>
...
# Ids for module
try {
    $Result = Invoke-FogIdsModule -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogIdsModule: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="ConvertTo-FogdivModule"></a>
# **ConvertTo-FogdivModule**
> Module ConvertTo-FogdivModule<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <Int32><br>
...
# Get one module by id
try {
    $Result = ConvertTo-FogdivModule -Id $Id
} catch {
    Write-Host ("Exception occurred when calling ConvertTo-FogdivModule: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Join-FogModule"></a>
# **Join-FogModule**
> void Join-FogModule<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-JoinModuleRequest] <PSCustomObject><br>
...
# Bulk edit module
try {
    $Result = Join-FogModule -JoinModuleRequest $JoinModuleRequest
} catch {
    Write-Host ("Exception occurred when calling Join-FogModule: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **JoinModuleRequest** | [**JoinModuleRequest**](JoinModuleRequest.md)|  | 
...
<a id="Invoke-FogListModule"></a>
# **Invoke-FogListModule**
> ListModule200Response Invoke-FogListModule<br>
...
# List module
try {
    $Result = Invoke-FogListModule -Start $Start -Length $Length -Expand $Expand -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogListModule: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
[**ListModule200Response**](ListModule200Response.md) (PSCustomObject)
...
<a id="Move-FogsModule"></a>
# **Move-FogsModule**
> SystemCollectionsHashtable[] Move-FogsModule<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Filter] <String><br>

Id and name pairs for module
...
# Id and name pairs for module
try {
    $Result = Move-FogsModule -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Move-FogsModule: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Search-FogModule"></a>
# **Search-FogModule**
> ListModule200Response Search-FogModule<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Item] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Start] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Length] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Expand] <String><br>
...
# Search module
try {
    $Result = Search-FogModule -Item $Item -Start $Start -Length $Length -Expand $Expand
} catch {
    Write-Host ("Exception occurred when calling Search-FogModule: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Update-FogModule"></a>
# **Update-FogModule**
> Module Update-FogModule<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <Int32><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Module] <PSCustomObject><br>
...
# Update a module
try {
    $Result = Update-FogModule -Id $Id -Module $Module
} catch {
    Write-Host ("Exception occurred when calling Update-FogModule: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
