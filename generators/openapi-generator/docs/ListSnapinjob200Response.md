...
**VarData** | [**Snapinjob[]**](Snapinjob.md) |  | [optional] 
...
```powershell
$ListSnapinjob200Response = Initialize-FogApiListSnapinjob200Response  -Draw null `
 -RecordsTotal null `
...
```powershell
$ListSnapinjob200Response | ConvertTo-JSON
```
