...
**VarData** | [**Rolepermission[]**](Rolepermission.md) |  | [optional] 
...
```powershell
$ListRolepermission200Response = Initialize-FogApiListRolepermission200Response  -Draw null `
 -RecordsTotal null `
...
```powershell
$ListRolepermission200Response | ConvertTo-JSON
```
