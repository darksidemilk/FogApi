# ListImagepartitiontype200Response
## Properties
...
**VarData** | [**Imagepartitiontype[]**](Imagepartitiontype.md) |  | [optional] 
...
```powershell
$ListImagepartitiontype200Response = Initialize-FogApiListImagepartitiontype200Response  -Draw null `
 -RecordsTotal null `
...
```powershell
$ListImagepartitiontype200Response | ConvertTo-JSON
```
