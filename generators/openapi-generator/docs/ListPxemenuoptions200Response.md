...
**VarData** | [**Pxemenuoptions[]**](Pxemenuoptions.md) |  | [optional] 
...
```powershell
$ListPxemenuoptions200Response = Initialize-FogApiListPxemenuoptions200Response  -Draw null `
 -RecordsTotal null `
...
```powershell
$ListPxemenuoptions200Response | ConvertTo-JSON
```
