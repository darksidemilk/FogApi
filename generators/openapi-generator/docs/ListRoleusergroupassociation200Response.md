# ListRoleusergroupassociation200Response
## Properties
...
**VarData** | [**Roleusergroupassociation[]**](Roleusergroupassociation.md) |  | [optional] 
...
```powershell
$ListRoleusergroupassociation200Response = Initialize-FogApiListRoleusergroupassociation200Response  -Draw null `
 -RecordsTotal null `
...
```powershell
$ListRoleusergroupassociation200Response | ConvertTo-JSON
```
