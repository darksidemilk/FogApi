...
**VarData** | [**Usergroupmember[]**](Usergroupmember.md) |  | [optional] 
...
```powershell
$ListUsergroupmember200Response = Initialize-FogApiListUsergroupmember200Response  -Draw null `
 -RecordsTotal null `
...
```powershell
$ListUsergroupmember200Response | ConvertTo-JSON
```
