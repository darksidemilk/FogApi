...
------------- | ------------- | -------------
[**Invoke-FogCountImage**](FogImageApi.md#Invoke-FogCountImage) | **GET** /image/count | Count image
[**New-FogImage**](FogImageApi.md#New-FogImage) | **POST** /image | Create a image
[**Invoke-FogDeleteImage**](FogImageApi.md#Invoke-FogDeleteImage) | **DELETE** /image/{id} | Delete a image
[**Invoke-FogIdsImage**](FogImageApi.md#Invoke-FogIdsImage) | **GET** /image/ids | Ids for image
[**ConvertTo-FogdivImage**](FogImageApi.md#ConvertTo-FogdivImage) | **GET** /image/{id} | Get one image by id
[**Join-FogImage**](FogImageApi.md#Join-FogImage) | **PUT** /image/join | Bulk edit image
[**Invoke-FogListImage**](FogImageApi.md#Invoke-FogListImage) | **GET** /image | List image
[**Move-FogsImage**](FogImageApi.md#Move-FogsImage) | **GET** /image/names | Id and name pairs for image
[**Search-FogImage**](FogImageApi.md#Search-FogImage) | **GET** /image/search/{item} | Search image
[**Update-FogImage**](FogImageApi.md#Update-FogImage) | **PUT** /image/{id} | Update a image


<a id="Invoke-FogCountImage"></a>
# **Invoke-FogCountImage**
> CountFiledeletequeue200Response Invoke-FogCountImage<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Filter] <String><br>
...
# Count image
try {
    $Result = Invoke-FogCountImage -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogCountImage: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
...
<a id="New-FogImage"></a>
# **New-FogImage**
> Image New-FogImage<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Image] <PSCustomObject><br>
...
# Create a image
try {
    $Result = New-FogImage -Image $Image
} catch {
    Write-Host ("Exception occurred when calling New-FogImage: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Invoke-FogDeleteImage"></a>
# **Invoke-FogDeleteImage**
> DeleteFiledeletequeue200Response Invoke-FogDeleteImage<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <Int32><br>
...
# Delete a image
try {
    $Result = Invoke-FogDeleteImage -Id $Id
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogDeleteImage: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Invoke-FogIdsImage"></a>
# **Invoke-FogIdsImage**
> SystemCollectionsHashtable[] Invoke-FogIdsImage<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Filter] <String><br>
...
# Ids for image
try {
    $Result = Invoke-FogIdsImage -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogIdsImage: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="ConvertTo-FogdivImage"></a>
# **ConvertTo-FogdivImage**
> Image ConvertTo-FogdivImage<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <Int32><br>
...
# Get one image by id
try {
    $Result = ConvertTo-FogdivImage -Id $Id
} catch {
    Write-Host ("Exception occurred when calling ConvertTo-FogdivImage: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Join-FogImage"></a>
# **Join-FogImage**
> void Join-FogImage<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-JoinImageRequest] <PSCustomObject><br>
...
# Bulk edit image
try {
    $Result = Join-FogImage -JoinImageRequest $JoinImageRequest
} catch {
    Write-Host ("Exception occurred when calling Join-FogImage: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **JoinImageRequest** | [**JoinImageRequest**](JoinImageRequest.md)|  | 
...
<a id="Invoke-FogListImage"></a>
# **Invoke-FogListImage**
> ListImage200Response Invoke-FogListImage<br>
...
# List image
try {
    $Result = Invoke-FogListImage -Start $Start -Length $Length -Expand $Expand -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Invoke-FogListImage: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
[**ListImage200Response**](ListImage200Response.md) (PSCustomObject)
...
<a id="Move-FogsImage"></a>
# **Move-FogsImage**
> SystemCollectionsHashtable[] Move-FogsImage<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Filter] <String><br>

Id and name pairs for image
...
# Id and name pairs for image
try {
    $Result = Move-FogsImage -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Move-FogsImage: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Search-FogImage"></a>
# **Search-FogImage**
> ListImage200Response Search-FogImage<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Item] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Start] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Length] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Expand] <String><br>
...
# Search image
try {
    $Result = Search-FogImage -Item $Item -Start $Start -Length $Length -Expand $Expand
} catch {
    Write-Host ("Exception occurred when calling Search-FogImage: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Update-FogImage"></a>
# **Update-FogImage**
> Image Update-FogImage<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <Int32><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Image] <PSCustomObject><br>
...
# Update a image
try {
    $Result = Update-FogImage -Id $Id -Image $Image
} catch {
    Write-Host ("Exception occurred when calling Update-FogImage: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
