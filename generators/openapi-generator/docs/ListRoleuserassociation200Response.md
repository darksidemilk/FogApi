...
**VarData** | [**Roleuserassociation[]**](Roleuserassociation.md) |  | [optional] 
...
```powershell
$ListRoleuserassociation200Response = Initialize-FogApiListRoleuserassociation200Response  -Draw null `
 -RecordsTotal null `
...
```powershell
$ListRoleuserassociation200Response | ConvertTo-JSON
```
