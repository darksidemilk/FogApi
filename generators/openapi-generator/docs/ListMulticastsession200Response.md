# ListMulticastsession200Response
## Properties
...
**VarData** | [**Multicastsession[]**](Multicastsession.md) |  | [optional] 
...
```powershell
$ListMulticastsession200Response = Initialize-FogApiListMulticastsession200Response  -Draw null `
 -RecordsTotal null `
...
```powershell
$ListMulticastsession200Response | ConvertTo-JSON
```
