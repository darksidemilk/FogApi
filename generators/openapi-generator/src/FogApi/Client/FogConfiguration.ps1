...
Get the configuration object 'FogConfiguration'.
...
#>
function Get-FogConfiguration {

    $Configuration = $Script:Configuration

    if ([string]::IsNullOrEmpty($Configuration["BaseUrl"])) {
        $Configuration["BaseUrl"] = "http://fog-dev/fog";
    }
...
None
#>
function Set-FogConfigurationApiKey {
    [CmdletBinding()]
    Param(
        [string]$Id,
        [AllowEmptyString()]
...
None
#>
function Set-FogConfigurationApiKeyPrefix {
    [CmdletBinding()]
    Param(
        [string]$Id,
        [AllowEmptyString()]
...
None
#>
function Set-FogConfigurationDefaultHeader {
    [CmdletBinding()]
    Param(
        [string]$Key,
        [AllowEmptyString()]
...
System.Collections.Hashtable[]
#>
function Get-FogHostSetting {
    return ,@(
          @{
            "Url" = "http://fog-dev/fog";
            "Description" = "This FOG server";
          }
    )
...
String
#>
function Get-FogUrlFromHostSetting {
...
System.Collections.Hashtable
#>
function Set-FogConfigurationHttpSigning {
    [CmdletBinding()]
    param(
    ...
    Process {
        ...
        $keyType = Get-FogKeyTypeFromFile -KeyFilePath $KeyFilePath
...
Get the configuration object 'FogConfigurationHttpSigning'.
...
[PSCustomObject]
#>
function Get-FogConfigurationHttpSigning{
