...
$dll = Join-Path $PSScriptRoot 'bin\FogProjectApi.private.dll'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\FogProjectApi.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './FogProjectApi.psd1'
$guid = Get-ModuleGuid -Psd1Path $psd1
$moduleName = 'FogProjectApi'
...
$formatPs1xml = Join-Path $PSScriptRoot './FogProjectApi.format.ps1xml'
