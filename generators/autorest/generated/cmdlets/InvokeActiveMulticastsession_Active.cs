...
namespace Sample.API.Cmdlets
{
    ...
    /// <summary>Also reachable as /active.</summary>
    /// <remarks>
    /// [OpenAPI] ActiveMulticastsession=>GET:"/multicastsession/current"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"ActiveMulticastsession_Active")]
    [global::System.Management.Automation.OutputType(typeof(Sample.API.Models.IPaths15NqvzeMulticastsessionCurrentGetResponses200ContentApplicationJsonSchema), typeof(Sample.API.Models.IError))]
    [global::Sample.API.Description(@"Also reachable as /active.")]
    [global::Sample.API.Generated]
    [global::Sample.API.HttpPath(Path = "/multicastsession/current", ApiVersion = "1.6.0-beta.4020")]
    public partial class InvokeActiveMulticastsession_Active : global::System.Management.Automation.PSCmdlet,
        ...
        Sample.API.Runtime.IContext
    {
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Sample.API.Models.IPaths15NqvzeMulticastsessionCurrentGetResponses200ContentApplicationJsonSchema">Sample.API.Models.IPaths15NqvzeMulticastsessionCurrentGetResponses200ContentApplicationJsonSchema</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IPaths15NqvzeMulticastsessionCurrentGetResponses200ContentApplicationJsonSchema> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InvokeActiveMulticastsession_Active" /> cmdlet class.
        /// </summary>
        public InvokeActiveMulticastsession_Active()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ActiveMulticastsession(onOk, onBadRequest, onUnauthorized, onForbidden, onNotFound, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IPaths15NqvzeMulticastsessionCurrentGetResponses200ContentApplicationJsonSchema> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Sample.API.Models.IPaths15NqvzeMulticastsessionCurrentGetResponses200ContentApplicationJsonSchema
                var result = (await response);
                if (null != result)
                {
                    if (0 == _responseSize)
