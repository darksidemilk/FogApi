...
namespace Sample.API.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"Image_UpdateViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class SetImage_UpdateViaIdentity : global::System.Management.Automation.PSCmdlet,
        ...
        Sample.API.Runtime.IContext
    {
        ...
        private Sample.API.Models.IImage _body;
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Responses may carry computed fields that are not columns and are not settable through the generic create/edit path: hosts, storagegroups, os, imagepartitiontype, imagetype.", ValueFromPipeline = true)]
        [Sample.API.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Responses may carry computed fields that are not columns and are not settable through the generic create/edit path: hosts, storagegroups, os, imagepartitiontype, imagetype.",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Sample.API.Models.IImage) })]
        [global::Sample.API.Category(global::Sample.API.ParameterCategory.Body)]
        public Sample.API.Models.IImage Body { get => this._body; set => this._body = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.UpdateImage(InputObject.Id ?? default(int), Body, onOk, onBadRequest, onUnauthorized, onForbidden, onNotFound, this, Pipeline, Sample.API.Runtime.SerializationMode.IncludeCreate);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SetImage_UpdateViaIdentity" /> cmdlet class.
        /// </summary>
        public SetImage_UpdateViaIdentity()
        {
