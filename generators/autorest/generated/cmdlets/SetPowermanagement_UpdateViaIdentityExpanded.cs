...
namespace Sample.API.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] UpdatePowermanagement=>PUT:"/powermanagement/{id}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"Powermanagement_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Sample.API.Models.IPowermanagement), typeof(Sample.API.Models.IError))]
    ...
    [global::Sample.API.HttpPath(Path = "/powermanagement/{id}", ApiVersion = "1.6.0-beta.4020")]
    public partial class SetPowermanagement_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Sample.API.Runtime.IContext
    {
        ...
        /// </summary>
        private Sample.API.Models.IPowermanagement _body = new Sample.API.Models.Powermanagement();
        ...
        SerializedName = @"dom",
        PossibleTypes = new [] { typeof(string) })]
        public string Dom { get => _body.Dom ?? null; set => _body.Dom = value; }
        ...
        SerializedName = @"dow",
        PossibleTypes = new [] { typeof(string) })]
        public string Dow { get => _body.Dow ?? null; set => _body.Dow = value; }
        ...
        SerializedName = @"min",
        PossibleTypes = new [] { typeof(string) })]
        public string Min { get => _body.Min ?? null; set => _body.Min = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string OnDemand { get => _body.OnDemand ?? null; set => _body.OnDemand = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Sample.API.Models.IPowermanagement">Sample.API.Models.IPowermanagement</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IPowermanagement> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'UpdatePowermanagement' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.UpdatePowermanagement(InputObject.Id ?? default(int), _body, onOk, onBadRequest, onUnauthorized, onForbidden, onNotFound, this, Pipeline, Sample.API.Runtime.SerializationMode.IncludeCreate);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SetPowermanagement_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public SetPowermanagement_UpdateViaIdentityExpanded()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IPowermanagement> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Sample.API.Models.IPowermanagement
                var result = (await response);
                if (null != result)
                {
                    if (0 == _responseSize)
