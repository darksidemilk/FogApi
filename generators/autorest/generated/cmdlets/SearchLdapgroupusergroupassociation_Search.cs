...
namespace Sample.API.Cmdlets
{
    ...
    /// <summary>
    /// Matches the term against the class name field. Returns the same envelope as a list. Takes no filter -- the match is the
    /// whole query.
    /// </summary>
    /// <remarks>
    /// [OpenAPI] SearchLdapgroupusergroupassociation=>GET:"/ldapgroupusergroupassociation/search/{item}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Search, @"Ldapgroupusergroupassociation_Search")]
    [global::System.Management.Automation.OutputType(typeof(Sample.API.Models.IPaths1RcjhhrLdapgroupusergroupassociationSearchItemGetResponses200ContentApplicationJsonSchema), typeof(Sample.API.Models.IError))]
    [global::Sample.API.Description(@"Matches the term against the class name field. Returns the same envelope as a list. Takes no filter -- the match is the whole query.")]
    [global::Sample.API.Generated]
    [global::Sample.API.HttpPath(Path = "/ldapgroupusergroupassociation/search/{item}", ApiVersion = "1.6.0-beta.4020")]
    public partial class SearchLdapgroupusergroupassociation_Search : global::System.Management.Automation.PSCmdlet,
        ...
        Sample.API.Runtime.IContext
    {
        ...
        /// on value.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Text to match against the id and name. A few classes match more: host also on MAC, storagenode on node hostname, setting on value.")]
        [Sample.API.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Sample.API.Models.IPaths1RcjhhrLdapgroupusergroupassociationSearchItemGetResponses200ContentApplicationJsonSchema">Sample.API.Models.IPaths1RcjhhrLdapgroupusergroupassociationSearchItemGetResponses200ContentApplicationJsonSchema</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IPaths1RcjhhrLdapgroupusergroupassociationSearchItemGetResponses200ContentApplicationJsonSchema> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.SearchLdapgroupusergroupassociation(Item, this.InvocationInformation.BoundParameters.ContainsKey("Start") ? Start : default(int?), this.InvocationInformation.BoundParameters.ContainsKey("Length") ? Length : default(int?), this.InvocationInformation.BoundParameters.ContainsKey("Expand") ? Expand : null, onOk, onBadRequest, onUnauthorized, onForbidden, onNotFound, this, Pipeline);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchLdapgroupusergroupassociation_Search" /> cmdlet class.
        /// </summary>
        public SearchLdapgroupusergroupassociation_Search()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IPaths1RcjhhrLdapgroupusergroupassociationSearchItemGetResponses200ContentApplicationJsonSchema> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Sample.API.Models.IPaths1RcjhhrLdapgroupusergroupassociationSearchItemGetResponses200ContentApplicationJsonSchema
                var result = (await response);
                if (null != result)
                {
                    if (0 == _responseSize)
