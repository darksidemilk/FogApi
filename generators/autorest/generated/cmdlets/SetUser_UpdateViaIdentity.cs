...
namespace Sample.API.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] UpdateUser=>PUT:"/user/{id}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"User_UpdateViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Sample.API.Models.IUser), typeof(Sample.API.Models.IError))]
    ...
    [global::Sample.API.HttpPath(Path = "/user/{id}", ApiVersion = "1.6.0-beta.4020")]
    public partial class SetUser_UpdateViaIdentity : global::System.Management.Automation.PSCmdlet,
        ...
        Sample.API.Runtime.IContext
    {
        ...
        private Sample.API.Models.IUser _body;

        /// <summary>
        /// Responses may carry computed fields that are not columns and are not settable through the generic create/edit path: roles,
        /// usergroups.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Responses may carry computed fields that are not columns and are not settable through the generic create/edit path: roles, usergroups.", ValueFromPipeline = true)]
        [Sample.API.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Responses may carry computed fields that are not columns and are not settable through the generic create/edit path: roles, usergroups.",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Sample.API.Models.IUser) })]
        [global::Sample.API.Category(global::Sample.API.ParameterCategory.Body)]
        public Sample.API.Models.IUser Body { get => this._body; set => this._body = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Sample.API.Models.IUser">Sample.API.Models.IUser</see> from the
        /// remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IUser> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.UpdateUser(InputObject.Id ?? default(int), Body, onOk, onBadRequest, onUnauthorized, onForbidden, onNotFound, this, Pipeline, Sample.API.Runtime.SerializationMode.IncludeCreate);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SetUser_UpdateViaIdentity" /> cmdlet class.
        /// </summary>
        public SetUser_UpdateViaIdentity()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IUser> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Sample.API.Models.IUser
                var result = (await response);
                if (null != result)
                {
                    if (0 == _responseSize)
