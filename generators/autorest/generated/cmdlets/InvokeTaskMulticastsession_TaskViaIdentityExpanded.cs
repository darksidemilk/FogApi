...
namespace Sample.API.Cmdlets
{
    ...
    /// <summary>
    /// Body accepts taskTypeID, taskName, shutdown, debug, deploySnapins, passreset, sessionjoin and wol. Wake-on-lan is this
    /// route with wol set, not a route of its own.
    /// </summary>
    /// <remarks>
    /// [OpenAPI] TaskMulticastsession=>POST:"/multicastsession/{id}/task"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"TaskMulticastsession_TaskViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Sample.API.Models.IListEnvelope), typeof(Sample.API.Models.IError))]
    [global::Sample.API.Description(@"Body accepts taskTypeID, taskName, shutdown, debug, deploySnapins, passreset, sessionjoin and wol. Wake-on-lan is this route with wol set, not a route of its own.")]
    [global::Sample.API.Generated]
    [global::Sample.API.HttpPath(Path = "/multicastsession/{id}/task", ApiVersion = "1.6.0-beta.4020")]
    public partial class InvokeTaskMulticastsession_TaskViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Sample.API.Runtime.IContext
    {
        ...
        private Sample.API.Models.IPaths6Fc679MulticastsessionIdTaskPostRequestbodyContentApplicationJsonSchema _body = new Sample.API.Models.Paths6Fc679MulticastsessionIdTaskPostRequestbodyContentApplicationJsonSchema();
        ...
        public Sample.API.Models.IAny Debug { get => _body.Debug ?? null /* object */; set => _body.Debug = value; }
        ...
        PossibleTypes = new [] { typeof(Sample.API.Models.IAny) })]
        public Sample.API.Models.IAny DeploySnapins { get => _body.DeploySnapins ?? null /* object */; set => _body.DeploySnapins = value; }
        ...
        PossibleTypes = new [] { typeof(Sample.API.Models.IAny) })]
        public Sample.API.Models.IAny Sessionjoin { get => _body.Sessionjoin ?? null /* object */; set => _body.Sessionjoin = value; }
        ...
        PossibleTypes = new [] { typeof(Sample.API.Models.IAny) })]
        public Sample.API.Models.IAny Shutdown { get => _body.Shutdown ?? null /* object */; set => _body.Shutdown = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string TaskName { get => _body.TaskName ?? null; set => _body.TaskName = value; }
        ...
        PossibleTypes = new [] { typeof(Sample.API.Models.IAny) })]
        public Sample.API.Models.IAny TaskTypeId { get => _body.TaskTypeId ?? null /* object */; set => _body.TaskTypeId = value; }
        ...
        SerializedName = @"wol",
        PossibleTypes = new [] { typeof(Sample.API.Models.IAny) })]
        public Sample.API.Models.IAny Wol { get => _body.Wol ?? null /* object */; set => _body.Wol = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Sample.API.Models.IListEnvelope">Sample.API.Models.IListEnvelope</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IListEnvelope> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InvokeTaskMulticastsession_TaskViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public InvokeTaskMulticastsession_TaskViaIdentityExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'TaskMulticastsession' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.TaskMulticastsession(InputObject.Id ?? default(int), _body, onOk, onBadRequest, onUnauthorized, onForbidden, onNotFound, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IListEnvelope> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Sample.API.Models.IListEnvelope
                var result = (await response);
                if (null != result)
                {
                    if (0 == _responseSize)
