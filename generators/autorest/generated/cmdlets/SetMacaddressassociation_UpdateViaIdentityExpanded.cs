...
namespace Sample.API.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] UpdateMacaddressassociation=>PUT:"/macaddressassociation/{id}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"Macaddressassociation_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Sample.API.Models.IMacaddressassociation), typeof(Sample.API.Models.IError))]
    ...
    [global::Sample.API.HttpPath(Path = "/macaddressassociation/{id}", ApiVersion = "1.6.0-beta.4020")]
    public partial class SetMacaddressassociation_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Sample.API.Runtime.IContext
    {
        ...
        /// </summary>
        private Sample.API.Models.IMacaddressassociation _body = new Sample.API.Models.Macaddressassociation();
        ...
        public string ClientIgnore { get => _body.ClientIgnore ?? null; set => _body.ClientIgnore = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string ImageIgnore { get => _body.ImageIgnore ?? null; set => _body.ImageIgnore = value; }
        ...
        SerializedName = @"mac",
        PossibleTypes = new [] { typeof(string) })]
        public string Mac { get => _body.Mac ?? null; set => _body.Mac = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Primary { get => _body.Primary ?? null; set => _body.Primary = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Sample.API.Models.IMacaddressassociation">Sample.API.Models.IMacaddressassociation</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IMacaddressassociation> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'UpdateMacaddressassociation' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.UpdateMacaddressassociation(InputObject.Id ?? default(int), _body, onOk, onBadRequest, onUnauthorized, onForbidden, onNotFound, this, Pipeline, Sample.API.Runtime.SerializationMode.IncludeCreate);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SetMacaddressassociation_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public SetMacaddressassociation_UpdateViaIdentityExpanded()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IMacaddressassociation> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Sample.API.Models.IMacaddressassociation
                var result = (await response);
                if (null != result)
                {
                    if (0 == _responseSize)
