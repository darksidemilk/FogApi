...
namespace Sample.API.Cmdlets
{
    ...
    /// <summary>
    /// multipart/form-data, not JSON. The file goes to the master storage node of the group given, and FOGSnapinReplicator propagates
    /// it to the rest of the group on its normal cycle. A file already present under the same basename is overwritten, matching
    /// the UI. Names matching /ssl/i are refused -- that path is reserved.
    /// </summary>
    /// <remarks>
    /// [OpenAPI] SnapinCreateWithFile=>POST:"/snapin/createwithfile"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"Snapin_Create1", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Sample.API.Models.ISnapin), typeof(Sample.API.Models.IError))]
    [global::Sample.API.Description(@"multipart/form-data, not JSON. The file goes to the master storage node of the group given, and FOGSnapinReplicator propagates it to the rest of the group on its normal cycle. A file already present under the same basename is overwritten, matching the UI. Names matching /ssl/i are refused -- that path is reserved.")]
    [global::Sample.API.Generated]
    [global::Sample.API.HttpPath(Path = "/snapin/createwithfile", ApiVersion = "1.6.0-beta.4020")]
    public partial class NewSnapin_Create1 : global::System.Management.Automation.PSCmdlet,
        ...
        Sample.API.Runtime.IContext
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The file itself.", ValueFromPipeline = true)]
        ...
        partial void overrideOnCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.ISnapin> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewSnapin_Create1" /> cmdlet class.
        /// </summary>
        public NewSnapin_Create1()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'SnapinCreateWithFile' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.SnapinCreateWithFile(Snapinfile, onCreated, onBadRequest, onUnauthorized, onForbidden, onNotFound, onInternalServerError, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.ISnapin> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
