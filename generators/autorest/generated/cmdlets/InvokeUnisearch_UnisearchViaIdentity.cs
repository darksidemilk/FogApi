...
namespace Sample.API.Cmdlets
{
    ...
    /// <summary>
    /// An optional trailing integer caps results PER CLASS, not overall, and this route is not paged -- there is no nextUrl to
    /// follow. Also reachable as /search.
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Unisearch=>GET:"/unisearch/{item}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"Unisearch_UnisearchViaIdentity")]
    [global::System.Management.Automation.OutputType(typeof(Sample.API.Models.IAny), typeof(Sample.API.Models.IError))]
    [global::Sample.API.Description(@"An optional trailing integer caps results PER CLASS, not overall, and this route is not paged -- there is no nextUrl to follow. Also reachable as /search.")]
    [global::Sample.API.Generated]
    [global::Sample.API.HttpPath(Path = "/unisearch/{item}", ApiVersion = "1.6.0-beta.4020")]
    public partial class InvokeUnisearch_UnisearchViaIdentity : global::System.Management.Automation.PSCmdlet,
        ...
        Sample.API.Runtime.IContext
    {
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Sample.API.Models.IAny">Sample.API.Models.IAny</see> from the remote
        /// call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IAny> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InvokeUnisearch_UnisearchViaIdentity" /> cmdlet class.
        /// </summary>
        public InvokeUnisearch_UnisearchViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.Unisearch(InputObject.Item ?? null, onOk, onBadRequest, onUnauthorized, onForbidden, onNotFound, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IAny> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Sample.API.Models.IAny
                var result = (await response);
                if (null != result)
                {
                    if (0 == _responseSize)
