...
namespace Sample.API.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] UpdateHostscreensetting=>PUT:"/hostscreensetting/{id}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"Hostscreensetting_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Sample.API.Models.IHostscreensetting), typeof(Sample.API.Models.IError))]
    ...
    [global::Sample.API.HttpPath(Path = "/hostscreensetting/{id}", ApiVersion = "1.6.0-beta.4020")]
    public partial class SetHostscreensetting_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Sample.API.Runtime.IContext
    {
        ...
        private Sample.API.Models.IHostscreensetting _body = new Sample.API.Models.Hostscreensetting();
        ...
        public int Height { get => _body.Height ?? default(int); set => _body.Height = value; }
        ...
        PossibleTypes = new [] { typeof(int) })]
        public int Orientation { get => _body.Orientation ?? default(int); set => _body.Orientation = value; }
        ...
        PossibleTypes = new [] { typeof(int) })]
        public int Other1 { get => _body.Other1 ?? default(int); set => _body.Other1 = value; }
        ...
        PossibleTypes = new [] { typeof(int) })]
        public int Other2 { get => _body.Other2 ?? default(int); set => _body.Other2 = value; }
        ...
        PossibleTypes = new [] { typeof(int) })]
        public int Refresh { get => _body.Refresh ?? default(int); set => _body.Refresh = value; }
        ...
        PossibleTypes = new [] { typeof(int) })]
        public int Width { get => _body.Width ?? default(int); set => _body.Width = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Sample.API.Models.IHostscreensetting">Sample.API.Models.IHostscreensetting</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IHostscreensetting> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'UpdateHostscreensetting' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.UpdateHostscreensetting(InputObject.Id ?? default(int), _body, onOk, onBadRequest, onUnauthorized, onForbidden, onNotFound, this, Pipeline, Sample.API.Runtime.SerializationMode.IncludeCreate);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SetHostscreensetting_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public SetHostscreensetting_UpdateViaIdentityExpanded()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IHostscreensetting> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Sample.API.Models.IHostscreensetting
                var result = (await response);
                if (null != result)
                {
                    if (0 == _responseSize)
