...
namespace Sample.API.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] UpdateLdapusergrant=>PUT:"/ldapusergrant/{id}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"Ldapusergrant_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Sample.API.Models.ILdapusergrant), typeof(Sample.API.Models.IError))]
    ...
    [global::Sample.API.HttpPath(Path = "/ldapusergrant/{id}", ApiVersion = "1.6.0-beta.4020")]
    public partial class SetLdapusergrant_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Sample.API.Runtime.IContext
    {
        ...
        private Sample.API.Models.ILdapusergrant _body = new Sample.API.Models.Ldapusergrant();
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string TargetId { get => _body.TargetId ?? null; set => _body.TargetId = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string TargetType { get => _body.TargetType ?? null; set => _body.TargetType = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string UserId { get => _body.UserId ?? null; set => _body.UserId = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Sample.API.Models.ILdapusergrant">Sample.API.Models.ILdapusergrant</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.ILdapusergrant> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'UpdateLdapusergrant' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.UpdateLdapusergrant(InputObject.Id ?? default(int), _body, onOk, onBadRequest, onUnauthorized, onForbidden, onNotFound, this, Pipeline, Sample.API.Runtime.SerializationMode.IncludeCreate);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SetLdapusergrant_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public SetLdapusergrant_UpdateViaIdentityExpanded()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.ILdapusergrant> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Sample.API.Models.ILdapusergrant
                var result = (await response);
                if (null != result)
                {
                    if (0 == _responseSize)
