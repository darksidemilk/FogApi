...
namespace Sample.API.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] UpdatePlugin=>PUT:"/plugin/{id}"
    /// </remarks>
    ...
    [global::System.Management.Automation.OutputType(typeof(Sample.API.Models.IPlugin), typeof(Sample.API.Models.IError))]
    ...
    [global::Sample.API.HttpPath(Path = "/plugin/{id}", ApiVersion = "1.6.0-beta.4020")]
        ...
        Sample.API.Runtime.IContext
    {
        ...
        /// </summary>
        private Sample.API.Models.IPlugin _body = new Sample.API.Models.Plugin();
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Sample.API.Models.IPlugin">Sample.API.Models.IPlugin</see> from
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'UpdatePlugin' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.UpdatePlugin(InputObject.Id ?? default(int), _body, onOk, onBadRequest, onUnauthorized, onForbidden, onNotFound, this, Pipeline, Sample.API.Runtime.SerializationMode.IncludeCreate);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SetPlugin_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
