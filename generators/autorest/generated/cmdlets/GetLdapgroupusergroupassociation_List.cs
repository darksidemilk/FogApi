...
namespace Sample.API.Cmdlets
{
    ...
    /// <summary>
    /// Also reachable as /list and /all. Filter with ?filter= or the equivalent trailing path segment; both take field=value
    /// pairs joined with &.
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ListLdapgroupusergroupassociation=>GET:"/ldapgroupusergroupassociation"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"Ldapgroupusergroupassociation_List")]
    [global::System.Management.Automation.OutputType(typeof(Sample.API.Models.IPathsBwhf8ELdapgroupusergroupassociationGetResponses200ContentApplicationJsonSchema), typeof(Sample.API.Models.IError))]
    [global::Sample.API.Description(@"Also reachable as /list and /all. Filter with ?filter= or the equivalent trailing path segment; both take field=value pairs joined with &.")]
    [global::Sample.API.Generated]
    [global::Sample.API.HttpPath(Path = "/ldapgroupusergroupassociation", ApiVersion = "1.6.0-beta.4020")]
    public partial class GetLdapgroupusergroupassociation_List : global::System.Management.Automation.PSCmdlet,
        ...
        Sample.API.Runtime.IContext
    {
        ...
        /// <summary>
        /// Comma separated relations to inline. Forces the page size to EXPAND_MAX_ITEMS, so an expanded page can come back smaller
        /// than the length asked for.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Comma separated relations to inline. Forces the page size to EXPAND_MAX_ITEMS, so an expanded page can come back smaller than the length asked for.")]
        [Sample.API.Runtime.Info(
        Required = false,
        ReadOnly = false,
        Description = @"Comma separated relations to inline. Forces the page size to EXPAND_MAX_ITEMS, so an expanded page can come back smaller than the length asked for.",
        ...
        /// <summary>
        /// Page size. Send it, together with start, on every list call: a request with no start is capped at MAX_ROWS and returns
        /// a partial result with truncated set.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Page size. Send it, together with start, on every list call: a request with no start is capped at MAX_ROWS and returns a partial result with truncated set.")]
        [Sample.API.Runtime.Info(
        Required = false,
        ReadOnly = false,
        Description = @"Page size. Send it, together with start, on every list call: a request with no start is capped at MAX_ROWS and returns a partial result with truncated set.",
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Row offset. Only honoured when length is also sent -- the server reads start from inside the length branch.")]
        [Sample.API.Runtime.Info(
        Required = false,
        ReadOnly = false,
        Description = @"Row offset. Only honoured when length is also sent -- the server reads start from inside the length branch.",
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Sample.API.Models.IPathsBwhf8ELdapgroupusergroupassociationGetResponses200ContentApplicationJsonSchema">Sample.API.Models.IPathsBwhf8ELdapgroupusergroupassociationGetResponses200ContentApplicationJsonSchema</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IPathsBwhf8ELdapgroupusergroupassociationGetResponses200ContentApplicationJsonSchema> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetLdapgroupusergroupassociation_List" /> cmdlet class.
        /// </summary>
        public GetLdapgroupusergroupassociation_List()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ListLdapgroupusergroupassociation(this.InvocationInformation.BoundParameters.ContainsKey("Start") ? Start : default(int?), this.InvocationInformation.BoundParameters.ContainsKey("Length") ? Length : default(int?), this.InvocationInformation.BoundParameters.ContainsKey("Expand") ? Expand : null, this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null, onOk, onBadRequest, onUnauthorized, onForbidden, onNotFound, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { Start=this.InvocationInformation.BoundParameters.ContainsKey("Start") ? Start : default(int?),Length=this.InvocationInformation.BoundParameters.ContainsKey("Length") ? Length : default(int?),Expand=this.InvocationInformation.BoundParameters.ContainsKey("Expand") ? Expand : null,Filter=this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null})
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IPathsBwhf8ELdapgroupusergroupassociationGetResponses200ContentApplicationJsonSchema> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Sample.API.Models.IPathsBwhf8ELdapgroupusergroupassociationGetResponses200ContentApplicationJsonSchema
                var result = (await response);
                if (null != result)
                {
                    if (0 == _responseSize)
