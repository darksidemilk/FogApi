...
namespace Sample.API.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] UpdateTasktype=>PUT:"/tasktype/{id}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"Tasktype_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Sample.API.Models.ITasktype), typeof(Sample.API.Models.IError))]
    ...
    [global::Sample.API.HttpPath(Path = "/tasktype/{id}", ApiVersion = "1.6.0-beta.4020")]
    public partial class SetTasktype_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Sample.API.Runtime.IContext
    {
        ...
        private Sample.API.Models.ITasktype _body = new Sample.API.Models.Tasktype();
        ...
        public string Access { get => _body.Access ?? null; set => _body.Access = value; }
        ...
        SerializedName = @"icon",
        PossibleTypes = new [] { typeof(string) })]
        public string Icon { get => _body.Icon ?? null; set => _body.Icon = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Initrd { get => _body.Initrd ?? null; set => _body.Initrd = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string IsAdvanced { get => _body.IsAdvanced ?? null; set => _body.IsAdvanced = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Sample.API.Models.ITasktype">Sample.API.Models.ITasktype</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.ITasktype> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'UpdateTasktype' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.UpdateTasktype(InputObject.Id ?? default(int), _body, onOk, onBadRequest, onUnauthorized, onForbidden, onNotFound, this, Pipeline, Sample.API.Runtime.SerializationMode.IncludeCreate);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SetTasktype_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public SetTasktype_UpdateViaIdentityExpanded()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.ITasktype> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Sample.API.Models.ITasktype
                var result = (await response);
                if (null != result)
                {
                    if (0 == _responseSize)
