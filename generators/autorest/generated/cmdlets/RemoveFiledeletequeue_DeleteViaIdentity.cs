...
namespace Sample.API.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] DeleteFiledeletequeue=>DELETE:"/filedeletequeue/{id}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"Filedeletequeue_DeleteViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Sample.API.Models.IPathsX452GoFiledeletequeueIdDeleteResponses200ContentApplicationJsonSchema), typeof(Sample.API.Models.IError))]
    ...
    public partial class RemoveFiledeletequeue_DeleteViaIdentity : global::System.Management.Automation.PSCmdlet,
        ...
        Sample.API.Runtime.IContext
    {
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Sample.API.Models.IPathsX452GoFiledeletequeueIdDeleteResponses200ContentApplicationJsonSchema">Sample.API.Models.IPathsX452GoFiledeletequeueIdDeleteResponses200ContentApplicationJsonSchema</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IPathsX452GoFiledeletequeueIdDeleteResponses200ContentApplicationJsonSchema> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'DeleteFiledeletequeue' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.DeleteFiledeletequeue(InputObject.Id ?? default(int), onOk, onBadRequest, onUnauthorized, onForbidden, onNotFound, this, Pipeline);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveFiledeletequeue_DeleteViaIdentity" /> cmdlet class.
        /// </summary>
        public RemoveFiledeletequeue_DeleteViaIdentity()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IPathsX452GoFiledeletequeueIdDeleteResponses200ContentApplicationJsonSchema> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Sample.API.Models.IPathsX452GoFiledeletequeueIdDeleteResponses200ContentApplicationJsonSchema
                var result = (await response);
                if (null != result)
                {
                    if (0 == _responseSize)
