...
namespace Sample.API.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] CancelSnapintask=>DELETE:"/snapintask/{id}/cancel"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Stop, @"Snapintask_CancelViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Sample.API.Models.IPaths10Q6732SnapintaskIdCancelDeleteResponses200ContentApplicationJsonSchema), typeof(Sample.API.Models.IError), typeof(Sample.API.Models.IPaths1D2Szq6SnapintaskIdCancelDeleteResponses409ContentApplicationJsonSchema))]
    ...
    [global::Sample.API.HttpPath(Path = "/snapintask/{id}/cancel", ApiVersion = "1.6.0-beta.4020")]
    public partial class StopSnapintask_CancelViaIdentity : global::System.Management.Automation.PSCmdlet,
        ...
        Sample.API.Runtime.IContext
    {
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Sample.API.Models.IPaths1D2Szq6SnapintaskIdCancelDeleteResponses409ContentApplicationJsonSchema">Sample.API.Models.IPaths1D2Szq6SnapintaskIdCancelDeleteResponses409ContentApplicationJsonSchema</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onConflict method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnConflict(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IPaths1D2Szq6SnapintaskIdCancelDeleteResponses409ContentApplicationJsonSchema> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Sample.API.Models.IPaths10Q6732SnapintaskIdCancelDeleteResponses200ContentApplicationJsonSchema">Sample.API.Models.IPaths10Q6732SnapintaskIdCancelDeleteResponses200ContentApplicationJsonSchema</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IPaths10Q6732SnapintaskIdCancelDeleteResponses200ContentApplicationJsonSchema> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'CancelSnapintask' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.CancelSnapintask(InputObject.Id ?? default(int), onOk, onBadRequest, onUnauthorized, onForbidden, onNotFound, onConflict, this, Pipeline);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StopSnapintask_CancelViaIdentity" /> cmdlet class.
        /// </summary>
        public StopSnapintask_CancelViaIdentity()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onConflict(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IPaths1D2Szq6SnapintaskIdCancelDeleteResponses409ContentApplicationJsonSchema> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Sample.API.Models.IPaths1D2Szq6SnapintaskIdCancelDeleteResponses409ContentApplicationJsonSchema
                var result = (await response);
                if (null != result)
                {
                    if (0 == _responseSize)
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IPaths10Q6732SnapintaskIdCancelDeleteResponses200ContentApplicationJsonSchema> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Sample.API.Models.IPaths10Q6732SnapintaskIdCancelDeleteResponses200ContentApplicationJsonSchema
                var result = (await response);
                if (null != result)
                {
                    if (0 == _responseSize)
