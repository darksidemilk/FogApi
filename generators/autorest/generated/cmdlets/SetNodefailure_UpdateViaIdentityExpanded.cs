...
namespace Sample.API.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] UpdateNodefailure=>PUT:"/nodefailure/{id}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"Nodefailure_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Sample.API.Models.INodefailure), typeof(Sample.API.Models.IError))]
    ...
    [global::Sample.API.HttpPath(Path = "/nodefailure/{id}", ApiVersion = "1.6.0-beta.4020")]
    public partial class SetNodefailure_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Sample.API.Runtime.IContext
    {
        ...
        /// </summary>
        private Sample.API.Models.INodefailure _body = new Sample.API.Models.Nodefailure();
        ...
        public global::System.DateTime FailureTime { get => _body.FailureTime; set => _body.FailureTime = value; }
        ...
        PossibleTypes = new [] { typeof(int) })]
        public int StoragenodeId { get => _body.StoragenodeId; set => _body.StoragenodeId = value; }
        ...
        PossibleTypes = new [] { typeof(int) })]
        public int TaskId { get => _body.TaskId; set => _body.TaskId = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Sample.API.Models.INodefailure">Sample.API.Models.INodefailure</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.INodefailure> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'UpdateNodefailure' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.UpdateNodefailure(InputObject.Id ?? default(int), _body, onOk, onBadRequest, onUnauthorized, onForbidden, onNotFound, this, Pipeline, Sample.API.Runtime.SerializationMode.IncludeCreate);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SetNodefailure_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public SetNodefailure_UpdateViaIdentityExpanded()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.INodefailure> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Sample.API.Models.INodefailure
                var result = (await response);
                if (null != result)
                {
                    if (0 == _responseSize)
