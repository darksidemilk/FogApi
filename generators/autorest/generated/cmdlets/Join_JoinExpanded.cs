...
namespace Sample.API.Cmdlets
{
    ...
    /// <summary>
    /// Takes a list of names and returns an id for each: the existing object where the name is already taken, a newly created
    /// one otherwise. That pattern is often called an upsert -- join or insert -- and because the object may not exist yet it
    /// matches on the name rather than on an id. Safe to send repeatedly: the same names give the same ids back and no duplicates
    /// are made. Group only; every other class answers 400.
    /// </summary>
    /// <remarks>
    /// [OpenAPI] JoinByNameGroup=>POST:"/group/join"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Join, @"_JoinExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(int), typeof(Sample.API.Models.IError))]
    [global::Sample.API.Description(@"Takes a list of names and returns an id for each: the existing object where the name is already taken, a newly created one otherwise. That pattern is often called an upsert -- join or insert -- and because the object may not exist yet it matches on the name rather than on an id. Safe to send repeatedly: the same names give the same ids back and no duplicates are made. Group only; every other class answers 400.")]
    [global::Sample.API.Generated]
    [global::Sample.API.HttpPath(Path = "/group/join", ApiVersion = "1.6.0-beta.4020")]
    public partial class Join_JoinExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Sample.API.Runtime.IContext
    {
        ...
        private Sample.API.Models.IPaths1RbinrGroupJoinPostRequestbodyContentApplicationJsonSchema _body = new Sample.API.Models.Paths1RbinrGroupJoinPostRequestbodyContentApplicationJsonSchema();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Names to resolve. Each is created if no object already has it.")]
        ...
        public string[] Names { get => _body.Names?.ToArray() ?? null /* fixedArrayOf */; set => _body.Names = (value != null ? new System.Collections.Generic.List<string>(value) : null); }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="System.Collections.Generic.List<int>">System.Collections.Generic.List<int></see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onCreated method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<System.Collections.Generic.List<int>> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Join_JoinExpanded" /> cmdlet class.
        /// </summary>
        public Join_JoinExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'JoinByNameGroup' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.JoinByNameGroup(_body, onCreated, onBadRequest, onUnauthorized, onForbidden, onNotFound, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<System.Collections.Generic.List<int>> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be System.Collections.Generic.List<int>
                var result = (await response);
                // response should be returning an array of some kind. +Pageable
                // array / <none> / <none>
                if (null != result)
