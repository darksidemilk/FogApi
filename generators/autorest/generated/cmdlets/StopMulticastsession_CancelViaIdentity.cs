...
namespace Sample.API.Cmdlets
{
    ...
    /// <summary>
    /// Only a task in a queued or in-progress state can be cancelled. Naming a resource whose task has already finished -- Complete,
    /// Cancelled or Failed -- answers 409 rather than reporting a success it did not perform.
    /// </summary>
    /// <remarks>
    /// [OpenAPI] CancelMulticastsession=>DELETE:"/multicastsession/{id}/cancel"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Stop, @"Multicastsession_CancelViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Sample.API.Models.IPathsBufxo2MulticastsessionIdCancelDeleteResponses200ContentApplicationJsonSchema), typeof(Sample.API.Models.IError), typeof(Sample.API.Models.IPathsWhb4QdMulticastsessionIdCancelDeleteResponses409ContentApplicationJsonSchema))]
    [global::Sample.API.Description(@"Only a task in a queued or in-progress state can be cancelled. Naming a resource whose task has already finished -- Complete, Cancelled or Failed -- answers 409 rather than reporting a success it did not perform.")]
    [global::Sample.API.Generated]
    [global::Sample.API.HttpPath(Path = "/multicastsession/{id}/cancel", ApiVersion = "1.6.0-beta.4020")]
    public partial class StopMulticastsession_CancelViaIdentity : global::System.Management.Automation.PSCmdlet,
        ...
        Sample.API.Runtime.IContext
    {
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Sample.API.Models.IPathsWhb4QdMulticastsessionIdCancelDeleteResponses409ContentApplicationJsonSchema">Sample.API.Models.IPathsWhb4QdMulticastsessionIdCancelDeleteResponses409ContentApplicationJsonSchema</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onConflict method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnConflict(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IPathsWhb4QdMulticastsessionIdCancelDeleteResponses409ContentApplicationJsonSchema> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Sample.API.Models.IPathsBufxo2MulticastsessionIdCancelDeleteResponses200ContentApplicationJsonSchema">Sample.API.Models.IPathsBufxo2MulticastsessionIdCancelDeleteResponses200ContentApplicationJsonSchema</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IPathsBufxo2MulticastsessionIdCancelDeleteResponses200ContentApplicationJsonSchema> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'CancelMulticastsession' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.CancelMulticastsession(InputObject.Id ?? default(int), onOk, onBadRequest, onUnauthorized, onForbidden, onNotFound, onConflict, this, Pipeline);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StopMulticastsession_CancelViaIdentity" /> cmdlet class.
        /// </summary>
        public StopMulticastsession_CancelViaIdentity()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onConflict(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IPathsWhb4QdMulticastsessionIdCancelDeleteResponses409ContentApplicationJsonSchema> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Sample.API.Models.IPathsWhb4QdMulticastsessionIdCancelDeleteResponses409ContentApplicationJsonSchema
                var result = (await response);
                if (null != result)
                {
                    if (0 == _responseSize)
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IPathsBufxo2MulticastsessionIdCancelDeleteResponses200ContentApplicationJsonSchema> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Sample.API.Models.IPathsBufxo2MulticastsessionIdCancelDeleteResponses200ContentApplicationJsonSchema
                var result = (await response);
                if (null != result)
                {
                    if (0 == _responseSize)
