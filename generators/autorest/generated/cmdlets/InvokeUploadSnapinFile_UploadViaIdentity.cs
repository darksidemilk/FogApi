...
namespace Sample.API.Cmdlets
{
    ...
    /// <summary>
    /// multipart/form-data, not JSON. Transport only -- no snapin row is created or touched, so this is how a caller pre-stages
    /// files to attach later. The field name must be snapinfiles[] even for a single file. Every file is validated before any
    /// transfer begins, but a failure part way through a batch leaves the earlier files in place.
    /// </summary>
    /// <remarks>
    /// [OpenAPI] UploadSnapinFiles=>POST:"/storagegroup/{id}/uploadsnapinfiles"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"UploadSnapinFile_UploadViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Sample.API.Models.IError))]
    [global::Sample.API.Description(@"multipart/form-data, not JSON. Transport only -- no snapin row is created or touched, so this is how a caller pre-stages files to attach later. The field name must be snapinfiles[] even for a single file. Every file is validated before any transfer begins, but a failure part way through a batch leaves the earlier files in place.")]
    [global::Sample.API.Generated]
    [global::Sample.API.HttpPath(Path = "/storagegroup/{id}/uploadsnapinfiles", ApiVersion = "1.6.0-beta.4020")]
    public partial class InvokeUploadSnapinFile_UploadViaIdentity : global::System.Management.Automation.PSCmdlet,
        ...
        Sample.API.Runtime.IContext
    {
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "One or more files. The field name carries the [] suffix on the wire: snapinfiles[].", ValueFromPipeline = true)]
        ...
        partial void overrideOnInternalServerError(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IError> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InvokeUploadSnapinFile_UploadViaIdentity" /> cmdlet class.
        /// </summary>
        public InvokeUploadSnapinFile_UploadViaIdentity()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'UploadSnapinFiles' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.UploadSnapinFiles(InputObject.Id ?? default(int), Snapinfiles, onNoContent, onBadRequest, onUnauthorized, onForbidden, onNotFound, onInternalServerError, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onInternalServerError(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IError> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
