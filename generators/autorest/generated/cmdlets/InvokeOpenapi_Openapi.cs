...
namespace Sample.API.Cmdlets
{
    ...
    /// <summary>
    /// Unauthenticated, and generated per request from this server's live routing and model metadata. Also served at /swagger.json,
    /// which is where most tooling looks first.
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Openapi=>GET:"/system/openapi"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"Openapi_Openapi")]
    [global::System.Management.Automation.OutputType(typeof(Sample.API.Models.IAny), typeof(Sample.API.Models.IError))]
    [global::Sample.API.Description(@"Unauthenticated, and generated per request from this server's live routing and model metadata. Also served at /swagger.json, which is where most tooling looks first.")]
    [global::Sample.API.Generated]
    [global::Sample.API.HttpPath(Path = "/system/openapi", ApiVersion = "1.6.0-beta.4020")]
    public partial class InvokeOpenapi_Openapi : global::System.Management.Automation.PSCmdlet,
        ...
        Sample.API.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InvokeOpenapi_Openapi" /> cmdlet class.
        /// </summary>
        public InvokeOpenapi_Openapi()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.Openapi(onOk, onBadRequest, onUnauthorized, onForbidden, onNotFound, this, Pipeline);
