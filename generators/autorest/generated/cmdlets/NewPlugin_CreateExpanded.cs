...
namespace Sample.API.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] CreatePlugin=>POST:"/plugin"
    /// </remarks>
        ...
        Sample.API.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewPlugin_CreateExpanded" /> cmdlet class.
        /// </summary>
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'CreatePlugin' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.CreatePlugin(_body, onOk, onBadRequest, onUnauthorized, onForbidden, onNotFound, this, Pipeline);
