...
namespace Sample.API.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] IndivTasklog=>GET:"/tasklog/{id}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"IndivTasklog_IndivViaIdentity")]
    [global::System.Management.Automation.OutputType(typeof(Sample.API.Models.ITasklog), typeof(Sample.API.Models.IError))]
    [global::Sample.API.Description(@"Fields withheld from list responses are returned here.")]
    [global::Sample.API.Generated]
    [global::Sample.API.HttpPath(Path = "/tasklog/{id}", ApiVersion = "1.6.0-beta.4020")]
    public partial class InvokeIndivTasklog_IndivViaIdentity : global::System.Management.Automation.PSCmdlet,
        ...
        Sample.API.Runtime.IContext
    {
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Sample.API.Models.ITasklog">Sample.API.Models.ITasklog</see> from
        /// the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.ITasklog> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InvokeIndivTasklog_IndivViaIdentity" /> cmdlet class.
        /// </summary>
        public InvokeIndivTasklog_IndivViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.IndivTasklog(InputObject.Id ?? default(int), onOk, onBadRequest, onUnauthorized, onForbidden, onNotFound, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.ITasklog> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Sample.API.Models.ITasklog
                var result = (await response);
                if (null != result)
                {
                    if (0 == _responseSize)
