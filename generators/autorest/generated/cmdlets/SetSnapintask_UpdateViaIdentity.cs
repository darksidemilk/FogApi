...
namespace Sample.API.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"Snapintask_UpdateViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class SetSnapintask_UpdateViaIdentity : global::System.Management.Automation.PSCmdlet,
        ...
        Sample.API.Runtime.IContext
    {
        ...
        private Sample.API.Models.ISnapintask _body;
        ...
        /// state, snapinjob.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Responses may carry computed fields that are not columns and are not settable through the generic create/edit path: snapin, state, snapinjob.", ValueFromPipeline = true)]
        [Sample.API.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Responses may carry computed fields that are not columns and are not settable through the generic create/edit path: snapin, state, snapinjob.",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Sample.API.Models.ISnapintask) })]
        [global::Sample.API.Category(global::Sample.API.ParameterCategory.Body)]
        public Sample.API.Models.ISnapintask Body { get => this._body; set => this._body = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.UpdateSnapintask(InputObject.Id ?? default(int), Body, onOk, onBadRequest, onUnauthorized, onForbidden, onNotFound, this, Pipeline, Sample.API.Runtime.SerializationMode.IncludeCreate);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SetSnapintask_UpdateViaIdentity" /> cmdlet class.
        /// </summary>
        public SetSnapintask_UpdateViaIdentity()
        {
